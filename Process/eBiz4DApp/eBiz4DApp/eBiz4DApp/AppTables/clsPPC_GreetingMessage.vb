'-- ------------------------------------------------------------
'-- Class name    :  clsPPC_GreetingMessage
...
Public Class clsPPC_GreetingMessage
#Region "Constants"
	Private Const PP_PPC_GreetingMessage As String = "PP_PPC_GreetingMessage"
#End Region 

#Region "Member Variables"
	Private mvarMessage As System.String
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Message", DbType.String,clsCommon.GetValueDBNull(Me.mvarMessage), ParameterDirection.Input,255 ))
			...
			DAL.ExecPreparedSQL(PP_PPC_GreetingMessage, CommandType.StoredProcedure, pc,"")
		Me.mvarMessage = clsCommon.GetValue(pc.Item("@Message").Value, mvarMessage.GetType().FullName)
		Return (Me.mvarMessage <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_PPC_GreetingMessage, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal Message As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Message",DbType.String, clsCommon.GetValueDBNull(Message), ParameterDirection.Input,255 ))
			Return (DAL.ExecNonQuery(PP_PPC_GreetingMessage, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal Message As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@Message", DbType.String, clsCommon.GetValueDBNull(Message), ParameterDirection.Input, 255 ))
			ds = DAL.ExecDataSet(PP_PPC_GreetingMessage, CommandType.StoredProcedure, pc,"")
			Dim keys(0) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("Message")
			Keys(0) = column
	...
	End Sub
	Public Function GetByKey(ByVal Message As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Message", DbType.String, clsCommon.GetValueDBNull(Message), ParameterDirection.InputOutput, 255 ))
			ds = DAL.ExecDataSet(PP_PPC_GreetingMessage, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		mvarMessage =  clsCommon.GetValue(row("Message"), mvarMessage.GetType().FullName)
