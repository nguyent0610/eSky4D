'-- ------------------------------------------------------------
'-- Class name    :  clsIF_SM_AttachedFile
...
Public Class clsIF_SM_AttachedFile
#Region "Constants"
	Private Const PP_IF_SM_AttachedFile As String = "PP_IF_SM_AttachedFile"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_IF_SM_AttachedFile, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_IF_SM_AttachedFile, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal MailID As System.Int32, ByVal FileName As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal MailID As System.Int32, ByVal FileName As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@MailID", DbType.int32, clsCommon.GetValueDBNull(MailID), ParameterDirection.Input, 4 ))
			pc.Add(New ParamStruct("@FileName", DbType.String, clsCommon.GetValueDBNull(FileName), ParameterDirection.Input, 200 ))
			ds = DAL.ExecDataSet(PP_IF_SM_AttachedFile, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal MailID As System.Int32, ByVal FileName As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
