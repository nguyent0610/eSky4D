...
Public Class clsAR_Area
#Region "Constants"
	Private Const PP_AR_Area As String = "PP_AR_Area"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_AR_Area, CommandType.StoredProcedure, pc,"")
		Me.mvarArea = clsCommon.GetValue(pc.Item("@Area").Value, mvarArea.GetType().FullName)
		Return (Me.mvarArea <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_AR_Area, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal Area As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Area",DbType.String, clsCommon.GetValueDBNull(Area), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_AR_Area, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal Area As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@Area", DbType.String, clsCommon.GetValueDBNull(Area), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_AR_Area, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal Area As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Area", DbType.String, clsCommon.GetValueDBNull(Area), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_AR_Area, CommandType.StoredProcedure, pc,"")
			me.Reset()
