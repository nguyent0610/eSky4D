'-- ------------------------------------------------------------
'-- Class name    :  clsPPC_SalesCustomer_Sync
...
Public Class clsPPC_SalesCustomer_Sync
#Region "Constants"
	Private Const PP_PPC_SalesCustomer_Sync As String = "PP_PPC_SalesCustomer_Sync"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_PPC_SalesCustomer_Sync, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LineAmt",DbType.Decimal, clsCommon.GetValueDBNull(me.mvarLineAmt), ParameterDirection.Input,8 ))
			 pc.Add(New ParamStruct("@IsWrk",DbType.String, clsCommon.GetValueDBNull(me.mvarIsWrk), ParameterDirection.Input,1 ))
			Return (DAL.ExecNonQuery(PP_PPC_SalesCustomer_Sync, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal IsWrk As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@CustID", DbType.String, clsCommon.GetValueDBNull(CustID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@IsWrk", DbType.String, clsCommon.GetValueDBNull(IsWrk), ParameterDirection.Input, 1 ))
			ds = DAL.ExecDataSet(PP_PPC_SalesCustomer_Sync, CommandType.StoredProcedure, pc,"")
