'-- ------------------------------------------------------------
'-- Class name    :  clsPPC_FeedbackQuestion
...
Public Class clsPPC_FeedbackQuestion
#Region "Constants"
	Private Const PP_PPC_FeedbackQuestion As String = "PP_PPC_FeedbackQuestion"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_PPC_FeedbackQuestion, CommandType.StoredProcedure, pc,"")
		Me.mvarFeedBackNo = clsCommon.GetValue(pc.Item("@FeedBackNo").Value, mvarFeedBackNo.GetType().FullName)
		Return True
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_PPC_FeedbackQuestion, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal FeedBackNo As System.Int32) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal FeedBackNo As System.Int32) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@FeedBackNo", DbType.int32, clsCommon.GetValueDBNull(FeedBackNo), ParameterDirection.Input, 4 ))
			ds = DAL.ExecDataSet(PP_PPC_FeedbackQuestion, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal FeedBackNo As System.Int32) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
