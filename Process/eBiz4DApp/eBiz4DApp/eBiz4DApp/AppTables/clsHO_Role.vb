...
Public Class clsHO_Role
#Region "Constants"
	Private Const PP_HO_Role As String = "PP_HO_Role"
#End Region 

#Region "Member Variables"
	Private mvarUserID As System.String

	Private mvarRole As System.String
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@UserID", DbType.String,clsCommon.GetValueDBNull(Me.mvarUserID), ParameterDirection.Input,8 ))
			pc.Add(New ParamStruct("@Role", DbType.String,clsCommon.GetValueDBNull(Me.mvarRole), ParameterDirection.Input,10 ))
			...
			DAL.ExecPreparedSQL(PP_HO_Role, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_HO_Role, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal UserID As System.String, ByVal Role As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@UserID",DbType.String, clsCommon.GetValueDBNull(UserID), ParameterDirection.Input,8 ))
			pc.Add(New ParamStruct("@Role",DbType.String, clsCommon.GetValueDBNull(Role), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_HO_Role, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal UserID As System.String, ByVal Role As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@UserID", DbType.String, clsCommon.GetValueDBNull(UserID), ParameterDirection.Input, 8 ))
			pc.Add(New ParamStruct("@Role", DbType.String, clsCommon.GetValueDBNull(Role), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_HO_Role, CommandType.StoredProcedure, pc,"")
			Dim keys(1) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("UserID")
			Keys(0) = column
			column = ds.Tables(0).Columns("Role")
			Keys(1) = column
	...
	End Sub
	Public Function GetByKey(ByVal UserID As System.String, ByVal Role As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@UserID", DbType.String, clsCommon.GetValueDBNull(UserID), ParameterDirection.InputOutput, 8 ))
			pc.Add(New ParamStruct("@Role", DbType.String, clsCommon.GetValueDBNull(Role), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_HO_Role, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarRole =  clsCommon.GetValue(row("Role"), mvarRole.GetType().FullName)
