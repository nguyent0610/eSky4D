...
Public Class clsIF_ExpAP
#Region "Constants"
	Private Const PP_IF_ExpAP As String = "PP_IF_ExpAP"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@BusinessType", DbType.String,clsCommon.GetValueDBNull(Me.mvarBusinessType), ParameterDirection.Input,10 ))
			DAL.ExecPreparedSQL(PP_IF_ExpAP, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@BusinessType",DbType.String, clsCommon.GetValueDBNull(me.mvarBusinessType), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_IF_ExpAP, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal InternetAddress As System.String, ByVal UsrID As System.String, ByVal ProgID As System.String, ByVal ProcID As System.String, ByVal BatNbr As System.String, ByVal BranchID As System.String, ByVal BusinessType As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BranchID",DbType.String, clsCommon.GetValueDBNull(BranchID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@BusinessType",DbType.String, clsCommon.GetValueDBNull(BusinessType), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_IF_ExpAP, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal InternetAddress As System.String, ByVal UsrID As System.String, ByVal ProgID As System.String, ByVal ProcID As System.String, ByVal BatNbr As System.String, ByVal BranchID As System.String, ByVal BusinessType As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BranchID",DbType.String, clsCommon.GetValueDBNull(BranchID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@BusinessType", DbType.String, clsCommon.GetValueDBNull(BusinessType), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_IF_ExpAP, CommandType.StoredProcedure, pc,"")
			Dim keys(6) As DataColumn
			...
			Keys(5) = column
			column = ds.Tables(0).Columns("BusinessType")
			Keys(6) = column
	...
	End Sub
	Public Function GetByKey(ByVal InternetAddress As System.String, ByVal UsrID As System.String, ByVal ProgID As System.String, ByVal ProcID As System.String, ByVal BatNbr As System.String, ByVal BranchID As System.String, ByVal BusinessType As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BusinessType", DbType.String, clsCommon.GetValueDBNull(BusinessType), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_IF_ExpAP, CommandType.StoredProcedure, pc,"")
			me.Reset()
