'-- ------------------------------------------------------------
'-- Class name    :  clsOM_AllocateSales
...
Public Class clsOM_AllocateSales
#Region "Constants"
	Private Const PP_OM_AllocateSales As String = "PP_OM_AllocateSales"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_AllocateSales, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@QtyUse",DbType.Decimal, clsCommon.GetValueDBNull(me.mvarQtyUse), ParameterDirection.Input,8 ))
			 pc.Add(New ParamStruct("@QtyAvail",DbType.Decimal, clsCommon.GetValueDBNull(me.mvarQtyAvail), ParameterDirection.Input,8 ))
			Return (DAL.ExecNonQuery(PP_OM_AllocateSales, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal AllocID As System.String, ByVal InvtID As System.String, ByVal SlsperID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal AllocID As System.String, ByVal InvtID As System.String, ByVal SlsperID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@SlsperID", DbType.String, clsCommon.GetValueDBNull(SlsperID), ParameterDirection.Input, 50 ))
			ds = DAL.ExecDataSet(PP_OM_AllocateSales, CommandType.StoredProcedure, pc,"")
	...
	Public Sub Reset()
		...
		mvarQtyAvail = 0
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal AllocID As System.String, ByVal InvtID As System.String, ByVal SlsperID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
