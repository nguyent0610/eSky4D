'-- ------------------------------------------------------------
'-- Class name    :  clsOM_DisplayCheckOrReturn
...
Public Class clsOM_DisplayCheckOrReturn
#Region "Constants"
	Private Const PP_OM_DisplayCheckOrReturn As String = "PP_OM_DisplayCheckOrReturn"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarFail As System.Boolean

	Private mvarReDisplay As System.Boolean

	Private mvarUnreDisplay As System.Boolean
...
#Region "Public Properties"
	...
	Public Property Fail() As System.Boolean
		Get
			Return mvarFail
		End Get
		Set(ByVal Value As System.Boolean)
	...
	Public Property ReDisplay() As System.Boolean
		Get
			Return mvarReDisplay
		End Get
		Set(ByVal Value As System.Boolean)
			mvarReDisplay = Value
		End Set
	...
	Public Property UnreDisplay() As System.Boolean
		Get
			Return mvarUnreDisplay
		End Get
		Set(ByVal Value As System.Boolean)
			mvarUnreDisplay = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@CpnyID", DbType.String,clsCommon.GetValueDBNull(Me.mvarCpnyID), ParameterDirection.Input,50 ))
			...
			pc.Add(New ParamStruct("@Fail", DbType.Boolean,clsCommon.GetValueDBNull(Me.mvarFail), ParameterDirection.Input,2 ))
			pc.Add(New ParamStruct("@ReDisplay", DbType.Boolean,clsCommon.GetValueDBNull(Me.mvarReDisplay), ParameterDirection.Input,2 ))
			pc.Add(New ParamStruct("@UnreDisplay", DbType.Boolean,clsCommon.GetValueDBNull(Me.mvarUnreDisplay), ParameterDirection.Input,2 ))
			...
			DAL.ExecPreparedSQL(PP_OM_DisplayCheckOrReturn, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_DisplayCheckOrReturn, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal DisplayID As System.String, ByVal CpnyID As System.String, ByVal SlsPerID As System.String, ByVal CustID As System.String) as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@CpnyID",DbType.String, clsCommon.GetValueDBNull(CpnyID), ParameterDirection.Input,50 ))
	...
	Public Function GetAll(ByVal DisplayID As System.String, ByVal CpnyID As System.String, ByVal SlsPerID As System.String, ByVal CustID As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@SlsPerID", DbType.String, clsCommon.GetValueDBNull(SlsPerID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@CustID", DbType.String, clsCommon.GetValueDBNull(CustID), ParameterDirection.Input, 50 ))
			ds = DAL.ExecDataSet(PP_OM_DisplayCheckOrReturn, CommandType.StoredProcedure, pc,"")
	...
	Public Function GetByKey(ByVal DisplayID As System.String, ByVal CpnyID As System.String, ByVal SlsPerID As System.String, ByVal CustID As System.String) as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@CpnyID", DbType.String, clsCommon.GetValueDBNull(CpnyID), ParameterDirection.InputOutput, 50 ))
	...
	Public Sub FillData(row as DataRow)
		...
		mvarFail =  clsCommon.GetValue(row("Fail"), mvarFail.GetType().FullName)
		mvarReDisplay =  clsCommon.GetValue(row("ReDisplay"), mvarReDisplay.GetType().FullName)
		mvarUnreDisplay =  clsCommon.GetValue(row("UnreDisplay"), mvarUnreDisplay.GetType().FullName)
