...
Public Class clsAR_Territory
#Region "Constants"
	Private Const PP_AR_Territory As String = "PP_AR_Territory"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_AR_Territory, CommandType.StoredProcedure, pc,"")
		Me.mvarTerritory = clsCommon.GetValue(pc.Item("@Territory").Value, mvarTerritory.GetType().FullName)
		Return (Me.mvarTerritory <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_AR_Territory, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal Territory As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal Territory As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@Territory", DbType.String, clsCommon.GetValueDBNull(Territory), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_AR_Territory, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal Territory As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
