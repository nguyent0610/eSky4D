...
#Region "Public Properties"
	...
	Public Property INTranLineRef() As System.String
		Get
			Return mvarINTranLineRef
		End Get
		Set(ByVal Value As System.String)
			mvarINTranLineRef = Value
		End Set
	End Property
...
#Region "Public Methods"
	...
	Public Function Update() as Boolean 
		...
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal BatNbr As System.String, ByVal RefNbr As System.String, ByVal LotSerNbr As System.String, ByVal INTranLineRef As System.String, ByVal UnitDesc As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@UnitDesc",DbType.String, clsCommon.GetValueDBNull(UnitDesc), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_IN_LotTrans, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal BatNbr As System.String, ByVal RefNbr As System.String, ByVal LotSerNbr As System.String, ByVal INTranLineRef As System.String, ByVal UnitDesc As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			Keys(3) = column
			column = ds.Tables(0).Columns("INTranLineRef")
			Keys(4) = column
			column = ds.Tables(0).Columns("UnitDesc")
			Keys(5) = column
	...
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal BatNbr As System.String, ByVal RefNbr As System.String, ByVal LotSerNbr As System.String, ByVal INTranLineRef As System.String, ByVal UnitDesc As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@UnitDesc", DbType.String, clsCommon.GetValueDBNull(UnitDesc), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_IN_LotTrans, CommandType.StoredProcedure, pc,"")
			me.Reset()
