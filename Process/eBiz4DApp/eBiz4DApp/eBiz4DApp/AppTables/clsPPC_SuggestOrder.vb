'-- ------------------------------------------------------------
'-- Class name    :  clsPPC_SuggestOrder
...
Public Class clsPPC_SuggestOrder
#Region "Constants"
	Private Const PP_PPC_SuggestOrder As String = "PP_PPC_SuggestOrder"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_PPC_SuggestOrder, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@InvtID",DbType.String, clsCommon.GetValueDBNull(me.mvarInvtID), ParameterDirection.Input,30 ))
			 pc.Add(New ParamStruct("@LineQty",DbType.Decimal, clsCommon.GetValueDBNull(me.mvarLineQty), ParameterDirection.Input,8 ))
			Return (DAL.ExecNonQuery(PP_PPC_SuggestOrder, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal CustID As System.String, ByVal InvtID As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@CustID", DbType.String, clsCommon.GetValueDBNull(CustID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_PPC_SuggestOrder, CommandType.StoredProcedure, pc,"")
