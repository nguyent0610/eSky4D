...
Public Class clsOM_DiscCpny
#Region "Constants"
	Private Const PP_OM_DiscCpny As String = "PP_OM_DiscCpny"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_DiscCpny, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@DiscSeq",DbType.String, clsCommon.GetValueDBNull(me.mvarDiscSeq), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@CpnyID",DbType.String, clsCommon.GetValueDBNull(me.mvarCpnyID), ParameterDirection.Input,30 ))
			Return (DAL.ExecNonQuery(PP_OM_DiscCpny, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal CpnyID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal CpnyID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@DiscSeq", DbType.String, clsCommon.GetValueDBNull(DiscSeq), ParameterDirection.Input, 10 ))
			pc.Add(New ParamStruct("@CpnyID", DbType.String, clsCommon.GetValueDBNull(CpnyID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_OM_DiscCpny, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal CpnyID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
