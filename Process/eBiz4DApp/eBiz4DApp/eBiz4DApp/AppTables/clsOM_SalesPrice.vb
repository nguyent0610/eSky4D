...
Public Class clsOM_SalesPrice
#Region "Constants"
	Private Const PP_OM_SalesPrice As String = "PP_OM_SalesPrice"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_SalesPrice, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_SalesPrice, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal PriceID As System.String, ByVal InvtID As System.String, ByVal SlsUnit As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@SlsUnit",DbType.String, clsCommon.GetValueDBNull(SlsUnit), ParameterDirection.Input,15 ))
			Return (DAL.ExecNonQuery(PP_OM_SalesPrice, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal PriceID As System.String, ByVal InvtID As System.String, ByVal SlsUnit As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@SlsUnit", DbType.String, clsCommon.GetValueDBNull(SlsUnit), ParameterDirection.Input, 15 ))
			ds = DAL.ExecDataSet(PP_OM_SalesPrice, CommandType.StoredProcedure, pc,"")
			...
			Keys(1) = column
			column = ds.Tables(0).Columns("SlsUnit")
			Keys(2) = column
	...
	End Sub
	Public Function GetByKey(ByVal PriceID As System.String, ByVal InvtID As System.String, ByVal SlsUnit As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@SlsUnit", DbType.String, clsCommon.GetValueDBNull(SlsUnit), ParameterDirection.InputOutput, 15 ))
			ds = DAL.ExecDataSet(PP_OM_SalesPrice, CommandType.StoredProcedure, pc,"")
			me.Reset()
