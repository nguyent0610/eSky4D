...
Public Class clsOM_DisplayInvt
#Region "Constants"
	Private Const PP_OM_DisplayInvt As String = "PP_OM_DisplayInvt"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_DisplayInvt, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_DisplayInvt, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal DisplayID As System.String, ByVal DispMethod As System.String, ByVal InvtID As System.String, ByVal Weight As System.Double) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@Weight", DbType.Decimal, clsCommon.GetValueDBNull(Weight), ParameterDirection.Input, 8 ))
			ds = DAL.ExecDataSet(PP_OM_DisplayInvt, CommandType.StoredProcedure, pc,"")
