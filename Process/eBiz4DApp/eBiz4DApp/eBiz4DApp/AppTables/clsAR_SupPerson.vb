...
#Region "Public Methods"
	...
	Public Function Delete(ByVal SupId As System.String) as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@SupId",DbType.String, clsCommon.GetValueDBNull(SupId), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_AR_SupPerson, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	...
	Public Function GetByKey(ByVal SupId As System.String) as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@SupId", DbType.String, clsCommon.GetValueDBNull(SupId), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_AR_SupPerson, CommandType.StoredProcedure, pc,"")
			me.Reset()
