...
Public Class clsOM_KPI_Segment
#Region "Constants"
	Private Const PP_OM_KPI_Segment As String = "PP_OM_KPI_Segment"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarSegID As System.String
...
#Region "Public Properties"
	...
	Public Property SegID() As System.String
		Get
			Return mvarSegID
		End Get
		Set(ByVal Value As System.String)
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@SegID", DbType.String,clsCommon.GetValueDBNull(Me.mvarSegID), ParameterDirection.Input,50 ))
			...
			DAL.ExecPreparedSQL(PP_OM_KPI_Segment, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_KPI_Segment, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal ID As System.String, ByVal CpnyID As System.String, ByVal SlsperID As System.String, ByVal SegID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@SegID",DbType.String, clsCommon.GetValueDBNull(SegID), ParameterDirection.Input,50 ))
			Return (DAL.ExecNonQuery(PP_OM_KPI_Segment, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal ID As System.String, ByVal CpnyID As System.String, ByVal SlsperID As System.String, ByVal SegID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@SlsperID", DbType.String, clsCommon.GetValueDBNull(SlsperID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@SegID", DbType.String, clsCommon.GetValueDBNull(SegID), ParameterDirection.Input, 50 ))
			ds = DAL.ExecDataSet(PP_OM_KPI_Segment, CommandType.StoredProcedure, pc,"")
			...
			Keys(2) = column
			column = ds.Tables(0).Columns("SegID")
			Keys(3) = column
	...
	End Sub
	Public Function GetByKey(ByVal ID As System.String, ByVal CpnyID As System.String, ByVal SlsperID As System.String, ByVal SegID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@SegID", DbType.String, clsCommon.GetValueDBNull(SegID), ParameterDirection.InputOutput, 50 ))
			ds = DAL.ExecDataSet(PP_OM_KPI_Segment, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarSegID =  clsCommon.GetValue(row("SegID"), mvarSegID.GetType().FullName)
