...
Public Class clsOM_DiscFreeItem
#Region "Constants"
	Private Const PP_OM_DiscFreeItem As String = "PP_OM_DiscFreeItem"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_DiscFreeItem, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_DiscFreeItem, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal LineRef As System.String, ByVal FreeItemID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal LineRef As System.String, ByVal FreeItemID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@LineRef", DbType.String, clsCommon.GetValueDBNull(LineRef), ParameterDirection.Input, 5 ))
			pc.Add(New ParamStruct("@FreeItemID", DbType.String, clsCommon.GetValueDBNull(FreeItemID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_OM_DiscFreeItem, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal LineRef As System.String, ByVal FreeItemID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
