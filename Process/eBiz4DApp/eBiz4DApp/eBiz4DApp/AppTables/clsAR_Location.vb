...
Public Class clsAR_Location
#Region "Constants"
	Private Const PP_AR_Location As String = "PP_AR_Location"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_AR_Location, CommandType.StoredProcedure, pc,"")
		Me.mvarLocation = clsCommon.GetValue(pc.Item("@Location").Value, mvarLocation.GetType().FullName)
		Return (Me.mvarLocation <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_AR_Location, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal Location As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Location",DbType.String, clsCommon.GetValueDBNull(Location), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_AR_Location, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal Location As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@Location", DbType.String, clsCommon.GetValueDBNull(Location), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_AR_Location, CommandType.StoredProcedure, pc,"")
			Dim keys(0) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("Location")
			Keys(0) = column
	...
	End Sub
	Public Function GetByKey(ByVal Location As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Location", DbType.String, clsCommon.GetValueDBNull(Location), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_AR_Location, CommandType.StoredProcedure, pc,"")
			me.Reset()
