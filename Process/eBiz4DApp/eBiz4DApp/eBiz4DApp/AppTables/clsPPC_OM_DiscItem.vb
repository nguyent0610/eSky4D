...
Public Class clsPPC_OM_DiscItem
#Region "Constants"
	Private Const PP_PPC_OM_DiscItem As String = "PP_PPC_OM_DiscItem"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_PPC_OM_DiscItem, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			 pc.Add(New ParamStruct("@UnitDesc",DbType.String, clsCommon.GetValueDBNull(me.mvarUnitDesc), ParameterDirection.Input,30 ))
			Return (DAL.ExecNonQuery(PP_PPC_OM_DiscItem, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal SlsperID As System.String, ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal InvtID As System.String, ByVal IsWrk As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal SlsperID As System.String, ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal InvtID As System.String, ByVal IsWrk As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@IsWrk", DbType.String, clsCommon.GetValueDBNull(IsWrk), ParameterDirection.Input, 1 ))
			ds = DAL.ExecDataSet(PP_PPC_OM_DiscItem, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal SlsperID As System.String, ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal InvtID As System.String, ByVal IsWrk As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
