...
Public Class clsOM_DiscDescrPro
#Region "Constants"
	Private Const PP_OM_DiscDescrPro As String = "PP_OM_DiscDescrPro"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_DiscDescrPro, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_DiscDescrPro, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal DiscCode As System.String, ByVal InvtID As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@DiscCode", DbType.String, clsCommon.GetValueDBNull(DiscCode), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_OM_DiscDescrPro, CommandType.StoredProcedure, pc,"")
