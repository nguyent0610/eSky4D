...
Public Class clsPO_PriceHeader
#Region "Constants"
	Private Const PP_PO_PriceHeader As String = "PP_PO_PriceHeader"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarEffDate As System.DateTime
...
#Region "Public Properties"
	...
	Public Property EffDate() As System.DateTime
		Get
			Return mvarEffDate
		End Get
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@EffDate", DbType.DateTime,clsCommon.GetValueDBNull(Me.mvarEffDate.Date), ParameterDirection.Input,16 ))
			...
			DAL.ExecPreparedSQL(PP_PO_PriceHeader, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			 pc.Add(New ParamStruct("@Disc",DbType.Decimal, clsCommon.GetValueDBNull(me.mvarDisc), ParameterDirection.Input,8 ))
			Return (DAL.ExecNonQuery(PP_PO_PriceHeader, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal PriceID As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@PriceID", DbType.String, clsCommon.GetValueDBNull(PriceID), ParameterDirection.Input, 20 ))
			ds = DAL.ExecDataSet(PP_PO_PriceHeader, CommandType.StoredProcedure, pc,"")
