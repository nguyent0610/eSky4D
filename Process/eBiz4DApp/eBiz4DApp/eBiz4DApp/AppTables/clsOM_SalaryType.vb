...
Public Class clsOM_SalaryType
#Region "Constants"
	Private Const PP_OM_SalaryType As String = "PP_OM_SalaryType"
#End Region 

#Region "Member Variables"
	Private mvarSalaryType As System.String
	...
	Private mvarSalary As System.Double

	Private mvarTargetType As System.String

	Private mvarTargetValue As System.Double
...
#Region "Public Properties"
	Public Property SalaryType() As System.String
		Get
			Return mvarSalaryType
		End Get
		Set(ByVal Value As System.String)
			mvarSalaryType = Value
		End Set
	End Property
	...
	Public Property Salary() As System.Double
		Get
			Return mvarSalary
		End Get
	...
	Public Property TargetType() As System.String
		Get
			Return mvarTargetType
		End Get
		Set(ByVal Value As System.String)
	...
	Public Property TargetValue() As System.Double
		Get
			Return mvarTargetValue
		End Get
		Set(ByVal Value As System.Double)
			mvarTargetValue = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@SalaryType", DbType.String,clsCommon.GetValueDBNull(Me.mvarSalaryType), ParameterDirection.Input,10 ))
			...
			pc.Add(New ParamStruct("@Salary", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarSalary), ParameterDirection.Input,8 ))
			pc.Add(New ParamStruct("@TargetType", DbType.String,clsCommon.GetValueDBNull(Me.mvarTargetType), ParameterDirection.Input,10 ))
			pc.Add(New ParamStruct("@TargetValue", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarTargetValue), ParameterDirection.Input,8 ))
			...
			DAL.ExecPreparedSQL(PP_OM_SalaryType, CommandType.StoredProcedure, pc,"")
		Me.mvarSalaryType = clsCommon.GetValue(pc.Item("@SalaryType").Value, mvarSalaryType.GetType().FullName)
		Return (Me.mvarSalaryType <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_SalaryType, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal SalaryType As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@SalaryType",DbType.String, clsCommon.GetValueDBNull(SalaryType), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_OM_SalaryType, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal SalaryType As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@SalaryType", DbType.String, clsCommon.GetValueDBNull(SalaryType), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_OM_SalaryType, CommandType.StoredProcedure, pc,"")
			Dim keys(0) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("SalaryType")
			Keys(0) = column
	...
	End Function
	Public Sub Reset()
		mvarSalaryType = String.Empty
		mvarActive = False
		mvarDescr = String.Empty
		mvarType = String.Empty
		mvarSalary = 0
		mvarTargetType = String.Empty
		mvarTargetValue = 0
	...
	End Sub
	Public Function GetByKey(ByVal SalaryType As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@SalaryType", DbType.String, clsCommon.GetValueDBNull(SalaryType), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_OM_SalaryType, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		mvarSalaryType =  clsCommon.GetValue(row("SalaryType"), mvarSalaryType.GetType().FullName)
		...
		mvarSalary =  clsCommon.GetValue(row("Salary"), mvarSalary.GetType().FullName)
		mvarTargetType =  clsCommon.GetValue(row("TargetType"), mvarTargetType.GetType().FullName)
		mvarTargetValue =  clsCommon.GetValue(row("TargetValue"), mvarTargetValue.GetType().FullName)
