...
#Region "Public Methods"
	...
	Public Function Update() as Boolean 
		...
		End Try
	End Function
	Public Function Delete(ByVal PriceID As System.String, ByVal VendID As System.String, ByVal InvtID As System.String, ByVal UOM As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal PriceID As System.String, ByVal VendID As System.String, ByVal InvtID As System.String, ByVal UOM As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
	...
	Public Sub Reset()
		...
		mvarDisc = 0
	End Sub
	Public Function GetByKey(ByVal PriceID As System.String, ByVal VendID As System.String, ByVal InvtID As System.String, ByVal UOM As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
