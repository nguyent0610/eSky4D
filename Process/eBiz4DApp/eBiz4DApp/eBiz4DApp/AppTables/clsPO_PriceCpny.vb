...
Public Class clsPO_PriceCpny
#Region "Constants"
	Private Const PP_PO_PriceCpny As String = "PP_PO_PriceCpny"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_PO_PriceCpny, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 pc.Add(New ParamStruct("@PriceID",DbType.String, clsCommon.GetValueDBNull(me.mvarPriceID), ParameterDirection.Input,20 ))
			 pc.Add(New ParamStruct("@CpnyID",DbType.String, clsCommon.GetValueDBNull(me.mvarCpnyID), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_PO_PriceCpny, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal PriceID As System.String, ByVal CpnyID As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@PriceID", DbType.String, clsCommon.GetValueDBNull(PriceID), ParameterDirection.Input, 20 ))
			pc.Add(New ParamStruct("@CpnyID", DbType.String, clsCommon.GetValueDBNull(CpnyID), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_PO_PriceCpny, CommandType.StoredProcedure, pc,"")
