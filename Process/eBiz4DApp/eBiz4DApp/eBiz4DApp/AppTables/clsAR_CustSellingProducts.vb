'-- ------------------------------------------------------------
'-- Class name    :  clsAR_CustSellingProducts
...
Public Class clsAR_CustSellingProducts
#Region "Constants"
	Private Const PP_AR_CustSellingProducts As String = "PP_AR_CustSellingProducts"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_AR_CustSellingProducts, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_AR_CustSellingProducts, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal CustID As System.String, ByVal Code As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal CustID As System.String, ByVal Code As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@CustID", DbType.String, clsCommon.GetValueDBNull(CustID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@Code", DbType.String, clsCommon.GetValueDBNull(Code), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_AR_CustSellingProducts, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal CustID As System.String, ByVal Code As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
