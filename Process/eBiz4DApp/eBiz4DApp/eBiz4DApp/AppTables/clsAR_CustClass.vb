...
Public Class clsAR_CustClass
#Region "Constants"
	Private Const PP_AR_CustClass As String = "PP_AR_CustClass"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_AR_CustClass, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@TaxID02",DbType.String, clsCommon.GetValueDBNull(me.mvarTaxID02), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@TaxID03",DbType.String, clsCommon.GetValueDBNull(me.mvarTaxID03), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_AR_CustClass, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal ClassId As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@ClassId", DbType.String, clsCommon.GetValueDBNull(ClassId), ParameterDirection.Input, 6 ))
			ds = DAL.ExecDataSet(PP_AR_CustClass, CommandType.StoredProcedure, pc,"")
