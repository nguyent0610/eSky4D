...
Public Class clsDS_Sync
#Region "Constants"
	Private Const PP_DS_Sync As String = "PP_DS_Sync"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarSyncDate As System.DateTime
...
#Region "Public Properties"
	...
	Public Property SyncDate() As System.DateTime
		Get
			Return mvarSyncDate
		End Get
		Set(ByVal Value As System.DateTime)
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@ListID", DbType.String,clsCommon.GetValueDBNull(Me.mvarListID), ParameterDirection.Input,2 ))
			pc.Add(New ParamStruct("@BranchID",DbType.String, clsCommon.GetValueDBNull(BranchID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@Code", DbType.String,clsCommon.GetValueDBNull(Me.mvarCode), ParameterDirection.Input,50 ))
			...
			pc.Add(New ParamStruct("@SyncDate", DbType.DateTime,clsCommon.GetValueDBNull(Me.mvarSyncDate), ParameterDirection.Input,16 ))
			DAL.ExecPreparedSQL(PP_DS_Sync, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			 pc.Add(New ParamStruct("@SyncDate",DbType.DateTime, clsCommon.GetValueDBNull(me.mvarSyncDate), ParameterDirection.Input,16 ))
			Return (DAL.ExecNonQuery(PP_DS_Sync, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal PlanID As System.String, ByVal ListID As System.String, ByVal BranchID As System.String, ByVal Code As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@PlanID",DbType.String, clsCommon.GetValueDBNull(PlanID), ParameterDirection.Input,6 ))
			pc.Add(New ParamStruct("@ListID",DbType.String, clsCommon.GetValueDBNull(ListID), ParameterDirection.Input,2 ))
			pc.Add(New ParamStruct("@BranchID",DbType.String, clsCommon.GetValueDBNull(BranchID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@Code",DbType.String, clsCommon.GetValueDBNull(Code), ParameterDirection.Input,50 ))
			Return (DAL.ExecNonQuery(PP_DS_Sync, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal PlanID As System.String, ByVal ListID As System.String, ByVal BranchID As System.String, ByVal Code As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BranchID",DbType.String, clsCommon.GetValueDBNull(BranchID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@Code", DbType.String, clsCommon.GetValueDBNull(Code), ParameterDirection.Input, 50 ))
			ds = DAL.ExecDataSet(PP_DS_Sync, CommandType.StoredProcedure, pc,"")
	...
	Public Sub Reset()
		...
		mvarSyncDate = Today
	End Sub
	Public Function GetByKey(ByVal PlanID As System.String, ByVal ListID As System.String, ByVal BranchID As System.String, ByVal Code As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@ListID", DbType.String, clsCommon.GetValueDBNull(ListID), ParameterDirection.InputOutput, 2 ))
			pc.Add(New ParamStruct("@BranchID", DbType.String, clsCommon.GetValueDBNull(BranchID), ParameterDirection.InputOutput, 30 ))
			pc.Add(New ParamStruct("@Code", DbType.String, clsCommon.GetValueDBNull(Code), ParameterDirection.InputOutput, 50 ))
			ds = DAL.ExecDataSet(PP_DS_Sync, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarSyncDate =  clsCommon.GetValue(row("SyncDate"), mvarSyncDate.GetType().FullName)
	End Sub
#End Region 
