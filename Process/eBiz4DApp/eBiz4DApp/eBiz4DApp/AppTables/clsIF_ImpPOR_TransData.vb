'-- ------------------------------------------------------------
'-- Class name    :  clsIF_ImpPOR_TransData
...
Public Class clsIF_ImpPOR_TransData
#Region "Constants"
	Private Const PP_IF_ImpPOR_TransData As String = "PP_IF_ImpPOR_TransData"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@BatNbr", DbType.String,clsCommon.GetValueDBNull(Me.mvarBatNbr), ParameterDirection.Input,15 ))
			...
			pc.Add(New ParamStruct("@UnitDescr", DbType.String,clsCommon.GetValueDBNull(Me.mvarUnitDescr), ParameterDirection.Input,12 ))
			pc.Add(New ParamStruct("@RcptUnitDescr", DbType.String,clsCommon.GetValueDBNull(Me.mvarRcptUnitDescr), ParameterDirection.Input,12 ))
			pc.Add(New ParamStruct("@PONbr", DbType.String,clsCommon.GetValueDBNull(Me.mvarPONbr), ParameterDirection.Input,10 ))
			...
			DAL.ExecPreparedSQL(PP_IF_ImpPOR_TransData, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@RcptMultDiv",DbType.String, clsCommon.GetValueDBNull(me.mvarRcptMultDiv), ParameterDirection.Input,1 ))
			 pc.Add(New ParamStruct("@RcptConvFact",DbType.Decimal, clsCommon.GetValueDBNull(me.mvarRcptConvFact), ParameterDirection.Input,8 ))
			Return (DAL.ExecNonQuery(PP_IF_ImpPOR_TransData, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal InternetAddress As System.String, ByVal UsrID As System.String, ByVal ProgID As System.String, ByVal ProcID As System.String, ByVal RecordID As System.Int32) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@ProcID", DbType.String, clsCommon.GetValueDBNull(ProcID), ParameterDirection.Input, 8 ))
			pc.Add(New ParamStruct("@RecordID", DbType.int32, clsCommon.GetValueDBNull(RecordID), ParameterDirection.Input, 4 ))
			ds = DAL.ExecDataSet(PP_IF_ImpPOR_TransData, CommandType.StoredProcedure, pc,"")
