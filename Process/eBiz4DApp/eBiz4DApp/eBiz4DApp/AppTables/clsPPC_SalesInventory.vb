'-- ------------------------------------------------------------
'-- Class name    :  clsPPC_SalesInventory
...
Public Class clsPPC_SalesInventory
#Region "Constants"
	Private Const PP_PPC_SalesInventory As String = "PP_PPC_SalesInventory"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarSortOrder As System.Int32
...
#Region "Public Properties"
	...
	Public Property SortOrder() As System.Int32
		Get
			Return mvarSortOrder
		End Get
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@SortOrder", DbType.int32,clsCommon.GetValueDBNull(Me.mvarSortOrder), ParameterDirection.Input,4 ))
			...
			DAL.ExecPreparedSQL(PP_PPC_SalesInventory, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_PPC_SalesInventory, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal InvtID As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_PPC_SalesInventory, CommandType.StoredProcedure, pc,"")
	...
	Public Sub FillData(row as DataRow)
		...
		mvarSortOrder =  clsCommon.GetValue(row("SortOrder"), mvarSortOrder.GetType().FullName)
