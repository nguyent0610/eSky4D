...
Public Class clsIN_WrkCosting
#Region "Constants"
	Private Const PP_IN_WrkCosting As String = "PP_IN_WrkCosting"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@MachineName", DbType.String,clsCommon.GetValueDBNull(Me.mvarMachineName), ParameterDirection.Input,21 ))
			...
			DAL.ExecPreparedSQL(PP_IN_WrkCosting, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_IN_WrkCosting, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal PerNbr As System.String, ByVal SiteID As System.String, ByVal InvtID As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@SiteID", DbType.String, clsCommon.GetValueDBNull(SiteID), ParameterDirection.Input, 10 ))
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_IN_WrkCosting, CommandType.StoredProcedure, pc,"")
