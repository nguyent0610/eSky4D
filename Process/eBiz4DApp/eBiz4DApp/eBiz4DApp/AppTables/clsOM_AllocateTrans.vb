'-- ------------------------------------------------------------
'-- Class name    :  clsOM_AllocateTrans
...
Public Class clsOM_AllocateTrans
#Region "Constants"
	Private Const PP_OM_AllocateTrans As String = "PP_OM_AllocateTrans"
#End Region 

#Region "Member Variables"
	Private mvarBranchID As System.String

	Private mvarAllocID As System.String
	...
	Private mvarInvtMul As System.Int16
...
#Region "Public Properties"
	...
	Public Property AllocID() As System.String
		Get
			Return mvarAllocID
		End Get
		Set(ByVal Value As System.String)
	...
	Public Property InvtMul() As System.Int16
		Get
			Return mvarInvtMul
		End Get
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@AllocID", DbType.String,clsCommon.GetValueDBNull(Me.mvarAllocID), ParameterDirection.Input,30 ))
			...
			pc.Add(New ParamStruct("@OrderNbr", DbType.String,clsCommon.GetValueDBNull(Me.mvarOrderNbr), ParameterDirection.Input,100 ))
			pc.Add(New ParamStruct("@Qty", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarQty), ParameterDirection.Input,8 ))
			pc.Add(New ParamStruct("@InvtMul", DbType.int16,clsCommon.GetValueDBNull(Me.mvarInvtMul), ParameterDirection.Input,2 ))
			...
			DAL.ExecPreparedSQL(PP_OM_AllocateTrans, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			 pc.Add(New ParamStruct("@TranDate",DbType.DateTime, clsCommon.GetValueDBNull(me.mvarTranDate), ParameterDirection.Input,16 ))
			Return (DAL.ExecNonQuery(PP_OM_AllocateTrans, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal AllocID As System.String, ByVal SlsperID As System.String, ByVal InvtID As System.String, ByVal LineRef As System.String, ByVal OrderNbr As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@AllocID",DbType.String, clsCommon.GetValueDBNull(AllocID), ParameterDirection.Input,30 ))
			...
			pc.Add(New ParamStruct("@OrderNbr",DbType.String, clsCommon.GetValueDBNull(OrderNbr), ParameterDirection.Input,100 ))
			Return (DAL.ExecNonQuery(PP_OM_AllocateTrans, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal AllocID As System.String, ByVal SlsperID As System.String, ByVal InvtID As System.String, ByVal LineRef As System.String, ByVal OrderNbr As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@LineRef", DbType.String, clsCommon.GetValueDBNull(LineRef), ParameterDirection.Input, 10 ))
			pc.Add(New ParamStruct("@OrderNbr", DbType.String, clsCommon.GetValueDBNull(OrderNbr), ParameterDirection.Input, 100 ))
			ds = DAL.ExecDataSet(PP_OM_AllocateTrans, CommandType.StoredProcedure, pc,"")
			Dim keys(5) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("BranchID")
			Keys(0) = column
			column = ds.Tables(0).Columns("AllocID")
			Keys(1) = column
	...
	Public Sub Reset()
		...
		mvarTranDate = Today
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal AllocID As System.String, ByVal SlsperID As System.String, ByVal InvtID As System.String, ByVal LineRef As System.String, ByVal OrderNbr As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@AllocID", DbType.String, clsCommon.GetValueDBNull(AllocID), ParameterDirection.InputOutput, 30 ))
			...
			pc.Add(New ParamStruct("@OrderNbr", DbType.String, clsCommon.GetValueDBNull(OrderNbr), ParameterDirection.InputOutput, 100 ))
			ds = DAL.ExecDataSet(PP_OM_AllocateTrans, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarAllocID =  clsCommon.GetValue(row("AllocID"), mvarAllocID.GetType().FullName)
		...
		mvarInvtMul =  clsCommon.GetValue(row("InvtMul"), mvarInvtMul.GetType().FullName)
