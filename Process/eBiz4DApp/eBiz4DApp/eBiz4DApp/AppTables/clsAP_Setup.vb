...
Public Class clsAP_Setup
#Region "Constants"
	Private Const PP_AP_Setup As String = "PP_AP_Setup"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarReqPPPONbr As System.Boolean
...
#Region "Public Properties"
	...
	Public Property ReqPPPONbr() As System.Boolean
		Get
			Return mvarReqPPPONbr
		End Get
		Set(ByVal Value As System.Boolean)
			mvarReqPPPONbr = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@ReqPPPONbr", DbType.Boolean,clsCommon.GetValueDBNull(Me.mvarReqPPPONbr), ParameterDirection.Input,2 ))
			DAL.ExecPreparedSQL(PP_AP_Setup, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			 pc.Add(New ParamStruct("@ReqPPPONbr",DbType.Boolean, clsCommon.GetValueDBNull(me.mvarReqPPPONbr), ParameterDirection.Input,2 ))
			Return (DAL.ExecNonQuery(PP_AP_Setup, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal BranchID As System.String, ByVal SetupID As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@BranchID", DbType.String, clsCommon.GetValueDBNull(BranchID), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@SetupID", DbType.String, clsCommon.GetValueDBNull(SetupID), ParameterDirection.Input, 2 ))
			ds = DAL.ExecDataSet(PP_AP_Setup, CommandType.StoredProcedure, pc,"")
	...
	Public Sub FillData(row as DataRow)
		...
		mvarReqPPPONbr =  clsCommon.GetValue(row("ReqPPPONbr"), mvarReqPPPONbr.GetType().FullName)
	End Sub
#End Region 
