'-- ------------------------------------------------------------
'-- Class name    :  clsSMS_SalesOrdDetWrk
...
Public Class clsSMS_SalesOrdDetWrk
#Region "Constants"
	Private Const PP_SMS_SalesOrdDetWrk As String = "PP_SMS_SalesOrdDetWrk"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_SMS_SalesOrdDetWrk, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@UnitRate",DbType.Decimal, clsCommon.GetValueDBNull(me.mvarUnitRate), ParameterDirection.Input,8 ))
			 pc.Add(New ParamStruct("@Status",DbType.int32, clsCommon.GetValueDBNull(me.mvarStatus), ParameterDirection.Input,4 ))
			Return (DAL.ExecNonQuery(PP_SMS_SalesOrdDetWrk, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll() as DataTable 
		...
		Try
			...
			ds = DAL.ExecDataSet(PP_SMS_SalesOrdDetWrk, CommandType.StoredProcedure, pc,"")
			Return ds.Tables(0)
		Catch ex As Exception
			Throw ex 
		End Try
