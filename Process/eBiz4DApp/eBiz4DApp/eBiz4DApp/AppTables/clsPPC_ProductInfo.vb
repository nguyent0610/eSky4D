...
Public Class clsPPC_ProductInfo
#Region "Constants"
	Private Const PP_PPC_ProductInfo As String = "PP_PPC_ProductInfo"
#End Region 

#Region "Member Variables"
	Private mvarInvtID As System.String

	Private mvarTechInfo As System.String

	Private mvarCustomerBenefit As System.String
...
#Region "Public Properties"
	...
	Public Property TechInfo() As System.String
		Get
			Return mvarTechInfo
		End Get
		Set(ByVal Value As System.String)
	...
	Public Property CustomerBenefit() As System.String
		Get
			Return mvarCustomerBenefit
		End Get
		Set(ByVal Value As System.String)
			mvarCustomerBenefit = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@TechInfo", DbType.String,clsCommon.GetValueDBNull(Me.mvarTechInfo), ParameterDirection.Input,255 ))
			pc.Add(New ParamStruct("@CustomerBenefit", DbType.String,clsCommon.GetValueDBNull(Me.mvarCustomerBenefit), ParameterDirection.Input,255 ))
			...
			DAL.ExecPreparedSQL(PP_PPC_ProductInfo, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_PPC_ProductInfo, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal InvtID As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_PPC_ProductInfo, CommandType.StoredProcedure, pc,"")
	...
	Public Sub Reset()
		...
		mvarTechInfo = String.Empty
		mvarCustomerBenefit = String.Empty
	...
	Public Sub FillData(row as DataRow)
		...
		mvarTechInfo =  clsCommon.GetValue(row("TechInfo"), mvarTechInfo.GetType().FullName)
		mvarCustomerBenefit =  clsCommon.GetValue(row("CustomerBenefit"), mvarCustomerBenefit.GetType().FullName)
