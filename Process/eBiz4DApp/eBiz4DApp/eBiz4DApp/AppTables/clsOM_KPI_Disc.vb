...
Public Class clsOM_KPI_Disc
#Region "Constants"
	Private Const PP_OM_KPI_Disc As String = "PP_OM_KPI_Disc"
#End Region 

#Region "Member Variables"
	Private mvarID As System.String

	Private mvarCTKM As System.String
...
#Region "Public Properties"
	...
	Public Property CTKM() As System.String
		Get
			Return mvarCTKM
		End Get
		Set(ByVal Value As System.String)
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@CTKM", DbType.String,clsCommon.GetValueDBNull(Me.mvarCTKM), ParameterDirection.Input,100 ))
			...
			DAL.ExecPreparedSQL(PP_OM_KPI_Disc, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_KPI_Disc, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal ID As System.String, ByVal CTKM As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@ID",DbType.String, clsCommon.GetValueDBNull(ID), ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@CTKM",DbType.String, clsCommon.GetValueDBNull(CTKM), ParameterDirection.Input,100 ))
			Return (DAL.ExecNonQuery(PP_OM_KPI_Disc, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal ID As System.String, ByVal CTKM As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@ID", DbType.String, clsCommon.GetValueDBNull(ID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@CTKM", DbType.String, clsCommon.GetValueDBNull(CTKM), ParameterDirection.Input, 100 ))
			ds = DAL.ExecDataSet(PP_OM_KPI_Disc, CommandType.StoredProcedure, pc,"")
			Dim keys(1) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("ID")
			Keys(0) = column
			column = ds.Tables(0).Columns("CTKM")
			Keys(1) = column
	...
	End Sub
	Public Function GetByKey(ByVal ID As System.String, ByVal CTKM As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@CTKM", DbType.String, clsCommon.GetValueDBNull(CTKM), ParameterDirection.InputOutput, 100 ))
			ds = DAL.ExecDataSet(PP_OM_KPI_Disc, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarCTKM =  clsCommon.GetValue(row("CTKM"), mvarCTKM.GetType().FullName)
