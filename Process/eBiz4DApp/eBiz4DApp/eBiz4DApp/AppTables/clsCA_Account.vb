...
Public Class clsCA_Account
#Region "Constants"
	Private Const PP_CA_Account As String = "PP_CA_Account"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarAcctNbr As System.String

	Private mvarActive As System.Boolean

	Private mvarAddrID As System.String

	Private mvarAcctName As System.String
...
#Region "Public Properties"
	...
	Public Property AcctNbr() As System.String
		Get
			Return mvarAcctNbr
		End Get
		Set(ByVal Value As System.String)
	...
	Public Property AcctName() As System.String
		Get
			Return mvarAcctName
		End Get
		Set(ByVal Value As System.String)
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@AcctNbr", DbType.String,clsCommon.GetValueDBNull(Me.mvarAcctNbr), ParameterDirection.Input,30 ))
			...
			pc.Add(New ParamStruct("@AcctName", DbType.String,clsCommon.GetValueDBNull(Me.mvarAcctName), ParameterDirection.Input,100 ))
			...
			DAL.ExecPreparedSQL(PP_CA_Account, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_CA_Account, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal BankAcct As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@BranchID",DbType.String, clsCommon.GetValueDBNull(BranchID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@BankAcct",DbType.String, clsCommon.GetValueDBNull(BankAcct), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_CA_Account, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal BankAcct As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BranchID",DbType.String, clsCommon.GetValueDBNull(BranchID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@BankAcct", DbType.String, clsCommon.GetValueDBNull(BankAcct), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_CA_Account, CommandType.StoredProcedure, pc,"")
			Dim keys(1) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("BranchID")
			Keys(0) = column
			column = ds.Tables(0).Columns("BankAcct")
			Keys(1) = column
	...
	Public Sub Reset()
		...
		mvarAcctNbr = String.Empty
		mvarActive = False
		mvarAddrID = String.Empty
		mvarAcctName = String.Empty
	...
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal BankAcct As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BankAcct", DbType.String, clsCommon.GetValueDBNull(BankAcct), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_CA_Account, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarAcctNbr =  clsCommon.GetValue(row("AcctNbr"), mvarAcctNbr.GetType().FullName)
		...
		mvarAcctName =  clsCommon.GetValue(row("AcctName"), mvarAcctName.GetType().FullName)
