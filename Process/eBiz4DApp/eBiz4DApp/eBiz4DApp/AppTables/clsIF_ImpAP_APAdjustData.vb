'-- ------------------------------------------------------------
'-- Class name    :  clsIF_ImpAP_APAdjustData
...
Public Class clsIF_ImpAP_APAdjustData
#Region "Constants"
	Private Const PP_IF_ImpAP_APAdjustData As String = "PP_IF_ImpAP_APAdjustData"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarAdjBatNbr As System.String
...
#Region "Public Properties"
	...
	Public Property AdjBatNbr() As System.String
		Get
			Return mvarAdjBatNbr
		End Get
		Set(ByVal Value As System.String)
			mvarAdjBatNbr = Value
		End Set
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@AdjBatNbr", DbType.String,clsCommon.GetValueDBNull(Me.mvarAdjBatNbr), ParameterDirection.Input,10 ))
			DAL.ExecPreparedSQL(PP_IF_ImpAP_APAdjustData, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@AdjBatNbr",DbType.String, clsCommon.GetValueDBNull(me.mvarAdjBatNbr), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_IF_ImpAP_APAdjustData, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal InternetAddress As System.String, ByVal UsrID As System.String, ByVal ProgID As System.String, ByVal ProcID As System.String, ByVal RecordID As System.Int32) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@ProcID", DbType.String, clsCommon.GetValueDBNull(ProcID), ParameterDirection.Input, 8 ))
			pc.Add(New ParamStruct("@RecordID", DbType.int32, clsCommon.GetValueDBNull(RecordID), ParameterDirection.Input, 4 ))
			ds = DAL.ExecDataSet(PP_IF_ImpAP_APAdjustData, CommandType.StoredProcedure, pc,"")
	...
	Public Sub FillData(row as DataRow)
		...
		mvarAdjBatNbr =  clsCommon.GetValue(row("AdjBatNbr"), mvarAdjBatNbr.GetType().FullName)
	End Sub
#End Region 
