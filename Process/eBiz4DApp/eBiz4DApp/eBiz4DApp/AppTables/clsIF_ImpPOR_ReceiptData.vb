'-- ------------------------------------------------------------
'-- Class name    :  clsIF_ImpPOR_ReceiptData
...
Public Class clsIF_ImpPOR_ReceiptData
#Region "Constants"
	Private Const PP_IF_ImpPOR_ReceiptData As String = "PP_IF_ImpPOR_ReceiptData"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_IF_ImpPOR_ReceiptData, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@RcptNbr",DbType.String, clsCommon.GetValueDBNull(me.mvarRcptNbr), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@VendID",DbType.String, clsCommon.GetValueDBNull(me.mvarVendID), ParameterDirection.Input,15 ))
			Return (DAL.ExecNonQuery(PP_IF_ImpPOR_ReceiptData, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal InternetAddress As System.String, ByVal UsrID As System.String, ByVal ProgID As System.String, ByVal ProcID As System.String, ByVal RecordID As System.Int32) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@ProcID", DbType.String, clsCommon.GetValueDBNull(ProcID), ParameterDirection.Input, 8 ))
			pc.Add(New ParamStruct("@RecordID", DbType.int32, clsCommon.GetValueDBNull(RecordID), ParameterDirection.Input, 4 ))
			ds = DAL.ExecDataSet(PP_IF_ImpPOR_ReceiptData, CommandType.StoredProcedure, pc,"")
