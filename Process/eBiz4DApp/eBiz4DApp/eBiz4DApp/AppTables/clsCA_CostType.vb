...
Public Class clsCA_CostType
#Region "Constants"
	Private Const PP_CA_CostType As String = "PP_CA_CostType"
#End Region 

#Region "Member Variables"
	Private mvarTypeID As System.String
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@TypeID", DbType.String,clsCommon.GetValueDBNull(Me.mvarTypeID), ParameterDirection.Input,25 ))
			...
			DAL.ExecPreparedSQL(PP_CA_CostType, CommandType.StoredProcedure, pc,"")
		Me.mvarTypeID = clsCommon.GetValue(pc.Item("@TypeID").Value, mvarTypeID.GetType().FullName)
		Return (Me.mvarTypeID <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_CA_CostType, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal TypeID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@TypeID",DbType.String, clsCommon.GetValueDBNull(TypeID), ParameterDirection.Input,25 ))
			Return (DAL.ExecNonQuery(PP_CA_CostType, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal TypeID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@TypeID", DbType.String, clsCommon.GetValueDBNull(TypeID), ParameterDirection.Input, 25 ))
			ds = DAL.ExecDataSet(PP_CA_CostType, CommandType.StoredProcedure, pc,"")
			Dim keys(0) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("TypeID")
			Keys(0) = column
	...
	End Sub
	Public Function GetByKey(ByVal TypeID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@TypeID", DbType.String, clsCommon.GetValueDBNull(TypeID), ParameterDirection.InputOutput, 25 ))
			ds = DAL.ExecDataSet(PP_CA_CostType, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		mvarTypeID =  clsCommon.GetValue(row("TypeID"), mvarTypeID.GetType().FullName)
