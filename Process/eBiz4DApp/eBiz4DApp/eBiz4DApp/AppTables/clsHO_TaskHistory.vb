...
Public Class clsHO_TaskHistory
#Region "Constants"
	Private Const PP_HO_TaskHistory As String = "PP_HO_TaskHistory"
#End Region 

#Region "Member Variables"
	Private mvarHistoryID As System.Int32
	...
	Private mvarAction As System.String
...
#Region "Public Properties"
	Public Property HistoryID() As System.Int32
		Get
			Return mvarHistoryID
		End Get
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@HistoryID", DbType.int32,clsCommon.GetValueDBNull(Me.mvarHistoryID), ParameterDirection.Input,4 ))
			pc.Add(New ParamStruct("@ObjID", DbType.String,clsCommon.GetValueDBNull(Me.mvarObjID), ParameterDirection.Input,200 ))
			...
			pc.Add(New ParamStruct("@Content", DbType.String,clsCommon.GetValueDBNull(Me.mvarContent), ParameterDirection.Input,250 ))
			pc.Add(New ParamStruct("@Action", DbType.String,clsCommon.GetValueDBNull(Me.mvarAction), ParameterDirection.Input,10 ))
			...
			DAL.ExecPreparedSQL(PP_HO_TaskHistory, CommandType.StoredProcedure, pc,"")
		Me.mvarHistoryID = clsCommon.GetValue(pc.Item("@HistoryID").Value, mvarHistoryID.GetType().FullName)
		Return True
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_HO_TaskHistory, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal HistoryID As System.Int32) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@HistoryID",DbType.int32, clsCommon.GetValueDBNull(HistoryID), ParameterDirection.Input,4 ))
			Return (DAL.ExecNonQuery(PP_HO_TaskHistory, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal HistoryID As System.Int32) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@HistoryID", DbType.int32, clsCommon.GetValueDBNull(HistoryID), ParameterDirection.Input, 4 ))
			ds = DAL.ExecDataSet(PP_HO_TaskHistory, CommandType.StoredProcedure, pc,"")
			Dim keys(0) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("HistoryID")
			Keys(0) = column
	...
	End Sub
	Public Function GetByKey(ByVal HistoryID As System.Int32) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@HistoryID", DbType.int32, clsCommon.GetValueDBNull(HistoryID), ParameterDirection.InputOutput, 4 ))
			ds = DAL.ExecDataSet(PP_HO_TaskHistory, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		mvarHistoryID =  clsCommon.GetValue(row("HistoryID"), mvarHistoryID.GetType().FullName)
		...
		mvarAction =  clsCommon.GetValue(row("Action"), mvarAction.GetType().FullName)
