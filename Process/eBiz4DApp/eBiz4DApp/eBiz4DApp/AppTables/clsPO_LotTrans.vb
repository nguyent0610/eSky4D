...
#Region "Member Variables"
	...
	Private mvarMfcDate As System.DateTime
...
#Region "Public Properties"
	...
	Public Property MfcDate() As System.DateTime
		Get
			Return mvarMfcDate
		End Get
		Set(ByVal Value As System.DateTime)
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@MfcDate", DbType.DateTime,clsCommon.GetValueDBNull(Me.mvarMfcDate.Date), ParameterDirection.Input,16 ))
	...
	Public Sub FillData(row as DataRow)
		...
		mvarMfcDate =  clsCommon.GetValue(row("MfcDate"), mvarMfcDate.GetType().FullName)
	End Sub
#End Region 
