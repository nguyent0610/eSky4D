...
Public Class clsOM_Shift
#Region "Constants"
	Private Const PP_OM_Shift As String = "PP_OM_Shift"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarStartTime As System.String

	Private mvarEndTime As System.String
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@StartTime", DbType.String,clsCommon.GetValueDBNull(Me.mvarStartTime), ParameterDirection.Input,20 ))
			pc.Add(New ParamStruct("@EndTime", DbType.String,clsCommon.GetValueDBNull(Me.mvarEndTime), ParameterDirection.Input,20 ))
			...
			DAL.ExecPreparedSQL(PP_OM_Shift, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_Shift, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal ShiftID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal ShiftID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@ShiftID", DbType.String, clsCommon.GetValueDBNull(ShiftID), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_OM_Shift, CommandType.StoredProcedure, pc,"")
	...
	Public Sub Reset()
		...
		mvarStartTime = String.Empty
		mvarEndTime = String.Empty
	...
	End Sub
	Public Function GetByKey(ByVal ShiftID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
	...
	Public Sub FillData(row as DataRow)
		...
		mvarStartTime =  clsCommon.GetValue(row("StartTime"), mvarStartTime.GetType().FullName)
		mvarEndTime =  clsCommon.GetValue(row("EndTime"), mvarEndTime.GetType().FullName)
