...
Public Class clsSI_Buyer
#Region "Constants"
	Private Const PP_SI_Buyer As String = "PP_SI_Buyer"
#End Region 

#Region "Member Variables"
	Private mvarBuyer As System.String

	Private mvarBuyerName As System.String
...
#Region "Public Properties"
	...
	Public Property BuyerName() As System.String
		Get
			Return mvarBuyerName
		End Get
		Set(ByVal Value As System.String)
			mvarBuyerName = Value
		End Set
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@BuyerName", DbType.String,clsCommon.GetValueDBNull(Me.mvarBuyerName), ParameterDirection.Input,30 ))
			...
			DAL.ExecPreparedSQL(PP_SI_Buyer, CommandType.StoredProcedure, pc,"")
		Me.mvarBuyer = clsCommon.GetValue(pc.Item("@Buyer").Value, mvarBuyer.GetType().FullName)
		Return (Me.mvarBuyer <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_SI_Buyer, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal Buyer As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Buyer",DbType.String, clsCommon.GetValueDBNull(Buyer), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_SI_Buyer, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal Buyer As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@Buyer", DbType.String, clsCommon.GetValueDBNull(Buyer), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_SI_Buyer, CommandType.StoredProcedure, pc,"")
			Dim keys(0) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("Buyer")
			Keys(0) = column
	...
	End Sub
	Public Function GetByKey(ByVal Buyer As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Buyer", DbType.String, clsCommon.GetValueDBNull(Buyer), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_SI_Buyer, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarBuyerName =  clsCommon.GetValue(row("BuyerName"), mvarBuyerName.GetType().FullName)
