'-- ------------------------------------------------------------
'-- Class name    :  clsIF_ImpAP_APTransData
...
Public Class clsIF_ImpAP_APTransData
#Region "Constants"
	Private Const PP_IF_ImpAP_APTransData As String = "PP_IF_ImpAP_APTransData"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarTaxIdDflt As System.String
...
#Region "Public Properties"
	...
	Public Property TaxIdDflt() As System.String
		Get
			Return mvarTaxIdDflt
		End Get
		Set(ByVal Value As System.String)
			mvarTaxIdDflt = Value
		End Set
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@TaxIdDflt", DbType.String,clsCommon.GetValueDBNull(Me.mvarTaxIdDflt), ParameterDirection.Input,10 ))
			pc.Add(New ParamStruct("@JrnlType", DbType.String,clsCommon.GetValueDBNull(Me.mvarJrnlType), ParameterDirection.Input,3 ))
			DAL.ExecPreparedSQL(PP_IF_ImpAP_APTransData, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@TaxIdDflt",DbType.String, clsCommon.GetValueDBNull(me.mvarTaxIdDflt), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@JrnlType",DbType.String, clsCommon.GetValueDBNull(me.mvarJrnlType), ParameterDirection.Input,3 ))
			Return (DAL.ExecNonQuery(PP_IF_ImpAP_APTransData, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal InternetAddress As System.String, ByVal UsrID As System.String, ByVal ProgID As System.String, ByVal ProcID As System.String, ByVal RecordID As System.Int32) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@ProcID", DbType.String, clsCommon.GetValueDBNull(ProcID), ParameterDirection.Input, 8 ))
			pc.Add(New ParamStruct("@RecordID", DbType.int32, clsCommon.GetValueDBNull(RecordID), ParameterDirection.Input, 4 ))
			ds = DAL.ExecDataSet(PP_IF_ImpAP_APTransData, CommandType.StoredProcedure, pc,"")
	...
	Public Sub FillData(row as DataRow)
		...
		mvarTaxIdDflt =  clsCommon.GetValue(row("TaxIdDflt"), mvarTaxIdDflt.GetType().FullName)
