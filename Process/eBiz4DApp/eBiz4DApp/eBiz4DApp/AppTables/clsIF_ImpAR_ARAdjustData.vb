'-- ------------------------------------------------------------
'-- Class name    :  clsIF_ImpAR_ARAdjustData
...
Public Class clsIF_ImpAR_ARAdjustData
#Region "Constants"
	Private Const PP_IF_ImpAR_ARAdjustData As String = "PP_IF_ImpAR_ARAdjustData"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_IF_ImpAR_ARAdjustData, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@AdjBatNbr",DbType.String, clsCommon.GetValueDBNull(me.mvarAdjBatNbr), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_IF_ImpAR_ARAdjustData, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal InternetAddress As System.String, ByVal UsrID As System.String, ByVal ProgID As System.String, ByVal ProcID As System.String, ByVal RecordID As System.Int32) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@ProcID", DbType.String, clsCommon.GetValueDBNull(ProcID), ParameterDirection.Input, 8 ))
			pc.Add(New ParamStruct("@RecordID", DbType.int32, clsCommon.GetValueDBNull(RecordID), ParameterDirection.Input, 4 ))
			ds = DAL.ExecDataSet(PP_IF_ImpAR_ARAdjustData, CommandType.StoredProcedure, pc,"")
