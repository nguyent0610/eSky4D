...
Public Class clsDNR_Header
#Region "Constants"
	Private Const PP_DNR_Header As String = "PP_DNR_Header"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarQuery As System.String
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Query", DbType.String,clsCommon.GetValueDBNull(Me.mvarQuery), ParameterDirection.Input,Nothing ))
			...
			DAL.ExecPreparedSQL(PP_DNR_Header, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_DNR_Header, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal ReportID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal ReportID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@ReportID", DbType.String, clsCommon.GetValueDBNull(ReportID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_DNR_Header, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal ReportID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
	...
	Public Sub FillData(row as DataRow)
		...
		mvarQuery =  clsCommon.GetValue(row("Query"), mvarQuery.GetType().FullName)
