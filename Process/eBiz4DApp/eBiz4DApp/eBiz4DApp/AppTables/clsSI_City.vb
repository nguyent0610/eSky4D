...
Public Class clsSI_City
#Region "Constants"
	Private Const PP_SI_City As String = "PP_SI_City"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_SI_City, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_SI_City, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal Country As System.String, ByVal State As System.String, ByVal City As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@City",DbType.String, clsCommon.GetValueDBNull(City), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_SI_City, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal Country As System.String, ByVal State As System.String, ByVal City As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@State", DbType.String, clsCommon.GetValueDBNull(State), ParameterDirection.Input, 10 ))
			pc.Add(New ParamStruct("@City", DbType.String, clsCommon.GetValueDBNull(City), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_SI_City, CommandType.StoredProcedure, pc,"")
			...
			Keys(1) = column
			column = ds.Tables(0).Columns("City")
			Keys(2) = column
	...
	End Sub
	Public Function GetByKey(ByVal Country As System.String, ByVal State As System.String, ByVal City As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@City", DbType.String, clsCommon.GetValueDBNull(City), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_SI_City, CommandType.StoredProcedure, pc,"")
			me.Reset()
