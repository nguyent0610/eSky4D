'-- ------------------------------------------------------------
'-- Class name    :  clsOM_UserProductClass
...
Public Class clsOM_UserProductClass
#Region "Constants"
	Private Const PP_OM_UserProductClass As String = "PP_OM_UserProductClass"
#End Region 

#Region "Member Variables"
	Private mvarUserID As System.String

	Private mvarProductClass As System.String
...
#Region "Public Properties"
	...
	Public Property ProductClass() As System.String
		Get
			Return mvarProductClass
		End Get
		Set(ByVal Value As System.String)
			mvarProductClass = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@ProductClass", DbType.String,clsCommon.GetValueDBNull(Me.mvarProductClass), ParameterDirection.Input,10 ))
			...
			DAL.ExecPreparedSQL(PP_OM_UserProductClass, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_UserProductClass, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal UserID As System.String, ByVal ProductClass As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@UserID",DbType.String, clsCommon.GetValueDBNull(UserID), ParameterDirection.Input,10 ))
			pc.Add(New ParamStruct("@ProductClass",DbType.String, clsCommon.GetValueDBNull(ProductClass), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_OM_UserProductClass, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal UserID As System.String, ByVal ProductClass As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@UserID", DbType.String, clsCommon.GetValueDBNull(UserID), ParameterDirection.Input, 10 ))
			pc.Add(New ParamStruct("@ProductClass", DbType.String, clsCommon.GetValueDBNull(ProductClass), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_OM_UserProductClass, CommandType.StoredProcedure, pc,"")
			Dim keys(1) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("UserID")
			Keys(0) = column
			column = ds.Tables(0).Columns("ProductClass")
			Keys(1) = column
	...
	End Sub
	Public Function GetByKey(ByVal UserID As System.String, ByVal ProductClass As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@ProductClass", DbType.String, clsCommon.GetValueDBNull(ProductClass), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_OM_UserProductClass, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarProductClass =  clsCommon.GetValue(row("ProductClass"), mvarProductClass.GetType().FullName)
