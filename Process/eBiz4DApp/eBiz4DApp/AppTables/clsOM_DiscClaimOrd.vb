...
Public Class clsOM_DiscClaimOrd
#Region "Constants"
	Private Const PP_OM_DiscClaimOrd As String = "PP_OM_DiscClaimOrd"
#End Region 
...
#Region "Public Properties"
	...
	Public Property SlsperName() As System.String
		Get
			Return mvarSlsperName
		End Get
		Set(ByVal Value As System.String)
			mvarSlsperName = Value
		End Set
	End Property
	...
	Public Property Use() As System.Int16
		Get
			Return mvarUse
		End Get
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@SlsperName", DbType.String,clsCommon.GetValueDBNull(Me.mvarSlsperName), ParameterDirection.Input,200 ))
			pc.Add(New ParamStruct("@CustID", DbType.String,clsCommon.GetValueDBNull(Me.mvarCustID), ParameterDirection.Input,100 ))
			pc.Add(New ParamStruct("@SlsperID", DbType.String,clsCommon.GetValueDBNull(Me.mvarSlsperID), ParameterDirection.Input,100 ))
			pc.Add(New ParamStruct("@Use", DbType.int16,clsCommon.GetValueDBNull(Me.mvarUse), ParameterDirection.Input,2 ))
			...
			DAL.ExecPreparedSQL(PP_OM_DiscClaimOrd, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_DiscClaimOrd, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal ClaimID As System.String, ByVal OrderNbr As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal ClaimID As System.String, ByVal OrderNbr As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@ClaimID", DbType.String, clsCommon.GetValueDBNull(ClaimID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@OrderNbr", DbType.String, clsCommon.GetValueDBNull(OrderNbr), ParameterDirection.Input, 50 ))
			ds = DAL.ExecDataSet(PP_OM_DiscClaimOrd, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal ClaimID As System.String, ByVal OrderNbr As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
	...
	Public Sub FillData(row as DataRow)
		...
		mvarSlsperName =  clsCommon.GetValue(row("SlsperName"), mvarSlsperName.GetType().FullName)
		...
		mvarUse =  clsCommon.GetValue(row("Use"), mvarUse.GetType().FullName)
