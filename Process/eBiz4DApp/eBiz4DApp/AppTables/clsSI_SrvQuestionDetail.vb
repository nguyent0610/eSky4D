'-- ------------------------------------------------------------
'-- Class name    :  clsSI_SrvQuestionDetail
...
Public Class clsSI_SrvQuestionDetail
#Region "Constants"
	Private Const PP_SI_SrvQuestionDetail As String = "PP_SI_SrvQuestionDetail"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@LineRef", DbType.String,clsCommon.GetValueDBNull(Me.mvarLineRef), ParameterDirection.Input,50 ))
			...
			DAL.ExecPreparedSQL(PP_SI_SrvQuestionDetail, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			 pc.Add(New ParamStruct("@ListID",DbType.String, clsCommon.GetValueDBNull(me.mvarListID), ParameterDirection.Input,50 ))
			Return (DAL.ExecNonQuery(PP_SI_SrvQuestionDetail, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal Number As System.String, ByVal LineRef As System.String, ByVal ListID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Number",DbType.String, clsCommon.GetValueDBNull(Number), ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@LineRef",DbType.String, clsCommon.GetValueDBNull(LineRef), ParameterDirection.Input,50 ))
		...
		End Try
	End Function
	Public Function GetAll(ByVal Number As System.String, ByVal LineRef As System.String, ByVal ListID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@LineRef", DbType.String, clsCommon.GetValueDBNull(LineRef), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@ListID", DbType.String, clsCommon.GetValueDBNull(ListID), ParameterDirection.Input, 50 ))
			ds = DAL.ExecDataSet(PP_SI_SrvQuestionDetail, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal Number As System.String, ByVal LineRef As System.String, ByVal ListID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@LineRef", DbType.String, clsCommon.GetValueDBNull(LineRef), ParameterDirection.InputOutput, 50 ))
