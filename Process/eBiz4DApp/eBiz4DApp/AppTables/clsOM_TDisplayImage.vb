'-- ------------------------------------------------------------
'-- Class name    :  clsOM_TDisplayImage
...
Public Class clsOM_TDisplayImage
#Region "Constants"
	Private Const PP_OM_TDisplayImage As String = "PP_OM_TDisplayImage"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarImageFile As System.String
...
#Region "Public Properties"
	...
	Public Property ImageFile() As System.String
		Get
			Return mvarImageFile
		End Get
		Set(ByVal Value As System.String)
			mvarImageFile = Value
		End Set
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@ImageFile", DbType.String,clsCommon.GetValueDBNull(Me.mvarImageFile), ParameterDirection.Input,500 ))
			pc.Add(New ParamStruct("@Pass", DbType.Boolean,clsCommon.GetValueDBNull(Me.mvarPass), ParameterDirection.Input,2 ))
			pc.Add(New ParamStruct("@ASM", DbType.String,clsCommon.GetValueDBNull(Me.mvarASM), ParameterDirection.Input,200 ))
			...
			DAL.ExecPreparedSQL(PP_OM_TDisplayImage, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,12 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_TDisplayImage, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal DisplayID As System.String, ByVal LevelID As System.String, ByVal LineRef As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal DisplayID As System.String, ByVal LevelID As System.String, ByVal LineRef As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@LevelID", DbType.String, clsCommon.GetValueDBNull(LevelID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@LineRef", DbType.String, clsCommon.GetValueDBNull(LineRef), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_OM_TDisplayImage, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal DisplayID As System.String, ByVal LevelID As System.String, ByVal LineRef As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
	...
	Public Sub FillData(row as DataRow)
		...
		mvarImageFile =  clsCommon.GetValue(row("ImageFile"), mvarImageFile.GetType().FullName)
