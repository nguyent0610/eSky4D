...
Public Class clsOM_SalPerObj
#Region "Constants"
	Private Const PP_OM_SalPerObj As String = "PP_OM_SalPerObj"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarMonth As System.String

	Private mvarName As System.String

	Private mvarActual As System.Double

	Private mvarObjective As System.Double

	Private mvarObjCover As System.Double

	Private mvarActualCover As System.Double
	...
	Private mvarOutlet As System.Int32
...
#Region "Public Properties"
	...
	Public Property Month() As System.String
		Get
			Return mvarMonth
		End Get
		Set(ByVal Value As System.String)
	...
	Public Property Actual() As System.Double
		Get
			Return mvarActual
		End Get
	...
	Public Property ActualCover() As System.Double
		Get
			Return mvarActualCover
		End Get
		Set(ByVal Value As System.Double)
			mvarActualCover = Value
		End Set
	End Property
	...
	Public Property Outlet() As System.Int32
		Get
			Return mvarOutlet
		End Get
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Month", DbType.String,clsCommon.GetValueDBNull(Me.mvarMonth), ParameterDirection.Input,5 ))
			pc.Add(New ParamStruct("@Name", DbType.String,clsCommon.GetValueDBNull(Me.mvarName), ParameterDirection.Input,100 ))
			pc.Add(New ParamStruct("@Actual", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarActual), ParameterDirection.Input,8 ))
			...
			pc.Add(New ParamStruct("@ActualCover", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarActualCover), ParameterDirection.Input,8 ))
			...
			pc.Add(New ParamStruct("@Outlet", DbType.int32,clsCommon.GetValueDBNull(Me.mvarOutlet), ParameterDirection.Input,4 ))
			DAL.ExecPreparedSQL(PP_OM_SalPerObj, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			 pc.Add(New ParamStruct("@Outlet",DbType.int32, clsCommon.GetValueDBNull(me.mvarOutlet), ParameterDirection.Input,4 ))
			Return (DAL.ExecNonQuery(PP_OM_SalPerObj, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal ProgID As System.String, ByVal SlsPerID As System.String, ByVal Month As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@Month",DbType.String, clsCommon.GetValueDBNull(Month), ParameterDirection.Input,5 ))
			Return (DAL.ExecNonQuery(PP_OM_SalPerObj, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal ProgID As System.String, ByVal SlsPerID As System.String, ByVal Month As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@SlsPerID", DbType.String, clsCommon.GetValueDBNull(SlsPerID), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@Month", DbType.String, clsCommon.GetValueDBNull(Month), ParameterDirection.Input, 5 ))
			ds = DAL.ExecDataSet(PP_OM_SalPerObj, CommandType.StoredProcedure, pc,"")
			...
			Keys(1) = column
			column = ds.Tables(0).Columns("Month")
			Keys(2) = column
	...
	Public Sub Reset()
		...
		mvarOutlet = 0
	End Sub
	Public Function GetByKey(ByVal ProgID As System.String, ByVal SlsPerID As System.String, ByVal Month As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@Month", DbType.String, clsCommon.GetValueDBNull(Month), ParameterDirection.InputOutput, 5 ))
			ds = DAL.ExecDataSet(PP_OM_SalPerObj, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarMonth =  clsCommon.GetValue(row("Month"), mvarMonth.GetType().FullName)
		...
		mvarActualCover =  clsCommon.GetValue(row("ActualCover"), mvarActualCover.GetType().FullName)
		...
		mvarOutlet =  clsCommon.GetValue(row("Outlet"), mvarOutlet.GetType().FullName)
	End Sub
#End Region 
