'-- ------------------------------------------------------------
'-- Class name    :  clsOM_SalesOrdGift
'-- Created date  :  7/8/2015
'-- Created by    :  
'-- Updated by    :  
...
Public Class clsOM_SalesOrdGift
#Region "Constants"
    Private Const PP_OM_SalesOrdGift As String = "PP_OM_SalesOrdGift"
#End Region
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            DAL.ExecPreparedSQL(PP_OM_SalesOrdGift, CommandType.StoredProcedure, pc, "")
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@LUpd_DateTime", DbType.DateTime, clsCommon.GetValueDBNull(Me.mvarLUpd_DateTime), ParameterDirection.Input, 16))
            pc.Add(New ParamStruct("@tstamp", DbType.String, clsCommon.GetValueDBNull(Me.mvartstamp), ParameterDirection.Input, 18))
            Return (DAL.ExecNonQuery(PP_OM_SalesOrdGift, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function Delete(ByVal BranchID As System.String, ByVal OrderNbr As System.String, ByVal Code As System.String, ByVal Type As System.String, ByVal InvtID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
        ...
        End Try
    End Function
    Public Function GetAll(ByVal BranchID As System.String, ByVal OrderNbr As System.String, ByVal Code As System.String, ByVal Type As System.String, ByVal InvtID As System.String) As DataTable
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@Type", DbType.String, clsCommon.GetValueDBNull(Type), ParameterDirection.Input, 15))
            pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30))
            ds = DAL.ExecDataSet(PP_OM_SalesOrdGift, CommandType.StoredProcedure, pc, "")
    ...
    End Sub
    Public Function GetByKey(ByVal BranchID As System.String, ByVal OrderNbr As System.String, ByVal Code As System.String, ByVal Type As System.String, ByVal InvtID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Dim ds As New DataSet
        Try
            Dim pc As New ParamCollection
