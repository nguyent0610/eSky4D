'-- ------------------------------------------------------------
'-- Class name    :  clsOM_SalesRouteDetTmp
...
Public Class clsOM_SalesRouteDetTmp
#Region "Constants"
	Private Const PP_OM_SalesRouteDetTmp As String = "PP_OM_SalesRouteDetTmp"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_SalesRouteDetTmp, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_SalesRouteDetTmp, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal ID As System.String, ByVal BranchID As System.String, ByVal SalesRouteID As System.String, ByVal CustID As System.String, ByVal SlsPerID As System.String, ByVal VisitDate As System.DateTime) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal ID As System.String, ByVal BranchID As System.String, ByVal SalesRouteID As System.String, ByVal CustID As System.String, ByVal SlsPerID As System.String, ByVal VisitDate As System.DateTime) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@SlsPerID", DbType.String, clsCommon.GetValueDBNull(SlsPerID), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@VisitDate", DbType.DateTime, clsCommon.GetValueDBNull(VisitDate), ParameterDirection.Input, 16 ))
			ds = DAL.ExecDataSet(PP_OM_SalesRouteDetTmp, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal ID As System.String, ByVal BranchID As System.String, ByVal SalesRouteID As System.String, ByVal CustID As System.String, ByVal SlsPerID As System.String, ByVal VisitDate As System.DateTime) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
