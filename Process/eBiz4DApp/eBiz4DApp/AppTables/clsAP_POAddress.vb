...
Public Class clsAP_POAddress
#Region "Constants"
	Private Const PP_AP_POAddress As String = "PP_AP_POAddress"
#End Region 

#Region "Member Variables"
	Private mvarVendId As System.String

	Private mvarOrdFromId As System.String
...
#Region "Public Properties"
	...
	Public Property OrdFromId() As System.String
		Get
			Return mvarOrdFromId
		End Get
		Set(ByVal Value As System.String)
			mvarOrdFromId = Value
		End Set
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@OrdFromId", DbType.String,clsCommon.GetValueDBNull(Me.mvarOrdFromId), ParameterDirection.Input,10 ))
			...
			pc.Add(New ParamStruct("@Fax", DbType.String,clsCommon.GetValueDBNull(Me.mvarFax), ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Name", DbType.String,clsCommon.GetValueDBNull(Me.mvarName), ParameterDirection.Input,50 ))
			...
			DAL.ExecPreparedSQL(PP_AP_POAddress, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_AP_POAddress, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal VendId As System.String, ByVal OrdFromId As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@VendId",DbType.String, clsCommon.GetValueDBNull(VendId), ParameterDirection.Input,15 ))
			pc.Add(New ParamStruct("@OrdFromId",DbType.String, clsCommon.GetValueDBNull(OrdFromId), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_AP_POAddress, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal VendId As System.String, ByVal OrdFromId As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@VendId", DbType.String, clsCommon.GetValueDBNull(VendId), ParameterDirection.Input, 15 ))
			pc.Add(New ParamStruct("@OrdFromId", DbType.String, clsCommon.GetValueDBNull(OrdFromId), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_AP_POAddress, CommandType.StoredProcedure, pc,"")
			Dim keys(1) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("VendId")
			Keys(0) = column
			column = ds.Tables(0).Columns("OrdFromId")
			Keys(1) = column
	...
	End Sub
	Public Function GetByKey(ByVal VendId As System.String, ByVal OrdFromId As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@OrdFromId", DbType.String, clsCommon.GetValueDBNull(OrdFromId), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_AP_POAddress, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarOrdFromId =  clsCommon.GetValue(row("OrdFromId"), mvarOrdFromId.GetType().FullName)
