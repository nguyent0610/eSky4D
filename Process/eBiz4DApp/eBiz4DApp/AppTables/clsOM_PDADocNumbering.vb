'-- ------------------------------------------------------------
'-- Class name    :  clsOM_PDADocNumbering
...
Public Class clsOM_PDADocNumbering
#Region "Constants"
	Private Const PP_OM_PDADocNumbering As String = "PP_OM_PDADocNumbering"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_PDADocNumbering, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@PreFixShip",DbType.String, clsCommon.GetValueDBNull(me.mvarPreFixShip), ParameterDirection.Input,5 ))
			 pc.Add(New ParamStruct("@PreFixSO",DbType.String, clsCommon.GetValueDBNull(me.mvarPreFixSO), ParameterDirection.Input,2 ))
			Return (DAL.ExecNonQuery(PP_OM_PDADocNumbering, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll() as DataTable 
		...
		Try
			...
			ds = DAL.ExecDataSet(PP_OM_PDADocNumbering, CommandType.StoredProcedure, pc,"")
			Return ds.Tables(0)
		Catch ex As Exception
			Throw ex 
		End Try
