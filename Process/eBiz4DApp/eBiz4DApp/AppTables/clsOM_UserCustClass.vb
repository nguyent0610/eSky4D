'-- ------------------------------------------------------------
'-- Class name    :  clsOM_UserCustClass
...
Public Class clsOM_UserCustClass
#Region "Constants"
	Private Const PP_OM_UserCustClass As String = "PP_OM_UserCustClass"
#End Region 

#Region "Member Variables"
	Private mvarUserID As System.String

	Private mvarCustClass As System.String
...
#Region "Public Properties"
	...
	Public Property CustClass() As System.String
		Get
			Return mvarCustClass
		End Get
		Set(ByVal Value As System.String)
			mvarCustClass = Value
		End Set
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@CustClass", DbType.String,clsCommon.GetValueDBNull(Me.mvarCustClass), ParameterDirection.Input,10 ))
			...
			DAL.ExecPreparedSQL(PP_OM_UserCustClass, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_UserCustClass, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal UserID As System.String, ByVal CustClass As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@UserID",DbType.String, clsCommon.GetValueDBNull(UserID), ParameterDirection.Input,10 ))
			pc.Add(New ParamStruct("@CustClass",DbType.String, clsCommon.GetValueDBNull(CustClass), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_OM_UserCustClass, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal UserID As System.String, ByVal CustClass As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@UserID", DbType.String, clsCommon.GetValueDBNull(UserID), ParameterDirection.Input, 10 ))
			pc.Add(New ParamStruct("@CustClass", DbType.String, clsCommon.GetValueDBNull(CustClass), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_OM_UserCustClass, CommandType.StoredProcedure, pc,"")
			Dim keys(1) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("UserID")
			Keys(0) = column
			column = ds.Tables(0).Columns("CustClass")
			Keys(1) = column
	...
	End Sub
	Public Function GetByKey(ByVal UserID As System.String, ByVal CustClass As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@CustClass", DbType.String, clsCommon.GetValueDBNull(CustClass), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_OM_UserCustClass, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarCustClass =  clsCommon.GetValue(row("CustClass"), mvarCustClass.GetType().FullName)
