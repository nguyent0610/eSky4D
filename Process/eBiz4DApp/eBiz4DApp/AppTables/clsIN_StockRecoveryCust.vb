'-- ------------------------------------------------------------
'-- Class name    :  clsIN_StockRecoveryCust
...
Public Class clsIN_StockRecoveryCust
#Region "Constants"
	Private Const PP_IN_StockRecoveryCust As String = "PP_IN_StockRecoveryCust"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarQtyGiveBack As System.Double
...
#Region "Public Properties"
	...
	Public Property QtyGiveBack() As System.Double
		Get
			Return mvarQtyGiveBack
		End Get
		Set(ByVal Value As System.Double)
			mvarQtyGiveBack = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@QtyGiveBack", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarQtyGiveBack), ParameterDirection.Input,8 ))
			...
			DAL.ExecPreparedSQL(PP_IN_StockRecoveryCust, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_IN_StockRecoveryCust, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal SlsPerID As System.String, ByVal StkRecNbr As System.String, ByVal InvtID As System.String, ByVal NewExpDate As System.DateTime) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@NewExpDate",DbType.DateTime, clsCommon.GetValueDBNull(NewExpDate), ParameterDirection.Input,16 ))
			Return (DAL.ExecNonQuery(PP_IN_StockRecoveryCust, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal SlsPerID As System.String, ByVal StkRecNbr As System.String, ByVal InvtID As System.String, ByVal NewExpDate As System.DateTime) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@NewExpDate", DbType.DateTime, clsCommon.GetValueDBNull(NewExpDate), ParameterDirection.Input, 16 ))
			ds = DAL.ExecDataSet(PP_IN_StockRecoveryCust, CommandType.StoredProcedure, pc,"")
			...
			Keys(3) = column
			column = ds.Tables(0).Columns("NewExpDate")
			Keys(4) = column
	...
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal SlsPerID As System.String, ByVal StkRecNbr As System.String, ByVal InvtID As System.String, ByVal NewExpDate As System.DateTime) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@NewExpDate", DbType.DateTime, clsCommon.GetValueDBNull(NewExpDate), ParameterDirection.InputOutput, 16 ))
			ds = DAL.ExecDataSet(PP_IN_StockRecoveryCust, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarQtyGiveBack =  clsCommon.GetValue(row("QtyGiveBack"), mvarQtyGiveBack.GetType().FullName)
