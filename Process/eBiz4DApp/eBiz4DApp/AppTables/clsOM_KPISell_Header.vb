'-- ------------------------------------------------------------
'-- Class name    :  clsOM_KPISell_Header
...
Public Class clsOM_KPISell_Header
#Region "Constants"
	Private Const PP_OM_KPISell_Header As String = "PP_OM_KPISell_Header"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_KPISell_Header, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_KPISell_Header, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal KPI As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@KPI", DbType.String, clsCommon.GetValueDBNull(KPI), ParameterDirection.Input, 50 ))
			ds = DAL.ExecDataSet(PP_OM_KPISell_Header, CommandType.StoredProcedure, pc,"")
