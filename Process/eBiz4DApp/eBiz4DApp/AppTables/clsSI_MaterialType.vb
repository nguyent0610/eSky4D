...
Public Class clsSI_MaterialType
#Region "Constants"
	Private Const PP_SI_MaterialType As String = "PP_SI_MaterialType"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_SI_MaterialType, CommandType.StoredProcedure, pc,"")
		Me.mvarMaterialType = clsCommon.GetValue(pc.Item("@MaterialType").Value, mvarMaterialType.GetType().FullName)
		Return (Me.mvarMaterialType <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_SI_MaterialType, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal MaterialType As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@MaterialType",DbType.String, clsCommon.GetValueDBNull(MaterialType), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_SI_MaterialType, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal MaterialType As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@MaterialType", DbType.String, clsCommon.GetValueDBNull(MaterialType), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_SI_MaterialType, CommandType.StoredProcedure, pc,"")
			Dim keys(0) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("MaterialType")
			Keys(0) = column
	...
	End Sub
	Public Function GetByKey(ByVal MaterialType As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@MaterialType", DbType.String, clsCommon.GetValueDBNull(MaterialType), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_SI_MaterialType, CommandType.StoredProcedure, pc,"")
			me.Reset()
