...
#Region "Member Variables"
	...
	Private mvarAccumulate As System.Boolean
...
#Region "Public Properties"
	...
	Public Property Accumulate() As System.Boolean
		Get
			Return mvarAccumulate
		End Get
		Set(ByVal Value As System.Boolean)
			mvarAccumulate = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Accumulate", DbType.Boolean,clsCommon.GetValueDBNull(Me.mvarAccumulate), ParameterDirection.Input,2 ))
	...
	Public Sub FillData(row as DataRow)
		...
		mvarAccumulate =  clsCommon.GetValue(row("Accumulate"), mvarAccumulate.GetType().FullName)
	End Sub
#End Region 
