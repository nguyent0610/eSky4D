...
#Region "Public Properties"
	...
	Public Property NumberCICO() As System.String
		Get
			Return mvarNumberCICO
		End Get
		Set(ByVal Value As System.String)
			mvarNumberCICO = Value
		End Set
	End Property
	...
	Public Property Stt() As System.Double
		Get
			Return mvarStt
		End Get
		Set(ByVal Value As System.Double)
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@NumberCICO", DbType.String,clsCommon.GetValueDBNull(Me.mvarNumberCICO), ParameterDirection.Input,2147483647 ))
			...
			pc.Add(New ParamStruct("@Stt", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarStt), ParameterDirection.Input,8 ))
	...
	Public Function Update() as Boolean 
		...
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal UpdateTime As System.DateTime, ByVal ID As System.Int32) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@UpdateTime",DbType.DateTime, clsCommon.GetValueDBNull(UpdateTime), ParameterDirection.Input,16 ))
		...
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal UpdateTime As System.DateTime, ByVal ID As System.Int32) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			Keys(1) = column
			column = ds.Tables(0).Columns("UpdateTime")
			Keys(2) = column
	...
	Public Sub Reset()
		...
		mvarNumberCICO = String.Empty
		mvarOrderNbr = String.Empty
		mvarOrdAmt = 0
		mvarStt = 0
		mvarID = 0
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal UpdateTime As System.DateTime, ByVal ID As System.Int32) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@UpdateTime", DbType.DateTime, clsCommon.GetValueDBNull(UpdateTime), ParameterDirection.InputOutput, 16 ))
	...
	Public Sub FillData(row as DataRow)
		...
		mvarNumberCICO =  clsCommon.GetValue(row("NumberCICO"), mvarNumberCICO.GetType().FullName)
