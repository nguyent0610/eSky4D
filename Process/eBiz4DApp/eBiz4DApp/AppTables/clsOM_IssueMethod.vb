...
Public Class clsOM_IssueMethod
#Region "Constants"
	Private Const PP_OM_IssueMethod As String = "PP_OM_IssueMethod"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_IssueMethod, CommandType.StoredProcedure, pc,"")
		Me.mvarIssueMethod = clsCommon.GetValue(pc.Item("@IssueMethod").Value, mvarIssueMethod.GetType().FullName)
		Return (Me.mvarIssueMethod <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_IssueMethod, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal IssueMethod As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@IssueMethod",DbType.String, clsCommon.GetValueDBNull(IssueMethod), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_OM_IssueMethod, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal IssueMethod As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@IssueMethod", DbType.String, clsCommon.GetValueDBNull(IssueMethod), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_OM_IssueMethod, CommandType.StoredProcedure, pc,"")
			Dim keys(0) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("IssueMethod")
			Keys(0) = column
	...
	End Sub
	Public Function GetByKey(ByVal IssueMethod As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@IssueMethod", DbType.String, clsCommon.GetValueDBNull(IssueMethod), ParameterDirection.InputOutput, 10 ))
			ds = DAL.ExecDataSet(PP_OM_IssueMethod, CommandType.StoredProcedure, pc,"")
			me.Reset()
