'-- ------------------------------------------------------------
'-- Class name    :  clsOM_TBonusCustomer
...
Public Class clsOM_TBonusCustomer
#Region "Constants"
	Private Const PP_OM_TBonusCustomer As String = "PP_OM_TBonusCustomer"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@BonusID", DbType.String,clsCommon.GetValueDBNull(Me.mvarBonusID), ParameterDirection.Input,50 ))
			...
			DAL.ExecPreparedSQL(PP_OM_TBonusCustomer, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,30 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_TBonusCustomer, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal BonusID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BonusID",DbType.String, clsCommon.GetValueDBNull(BonusID), ParameterDirection.Input,50 ))
			Return (DAL.ExecNonQuery(PP_OM_TBonusCustomer, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal BonusID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@CustID", DbType.String, clsCommon.GetValueDBNull(CustID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@BonusID", DbType.String, clsCommon.GetValueDBNull(BonusID), ParameterDirection.Input, 50 ))
			ds = DAL.ExecDataSet(PP_OM_TBonusCustomer, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal BonusID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BonusID", DbType.String, clsCommon.GetValueDBNull(BonusID), ParameterDirection.InputOutput, 50 ))
			ds = DAL.ExecDataSet(PP_OM_TBonusCustomer, CommandType.StoredProcedure, pc,"")
			me.Reset()
