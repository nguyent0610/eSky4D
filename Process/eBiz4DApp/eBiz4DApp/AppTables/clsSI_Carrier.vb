...
#Region "Member Variables"
	...
	Private mvarTerritoryID As System.String
...
#Region "Public Properties"
	...
	Public Property TerritoryID() As System.String
		Get
			Return mvarTerritoryID
		End Get
		Set(ByVal Value As System.String)
			mvarTerritoryID = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@ShipAccount", DbType.String,clsCommon.GetValueDBNull(Me.mvarShipAccount), ParameterDirection.Input,10 ))
			...
			pc.Add(New ParamStruct("@TerritoryID", DbType.String,clsCommon.GetValueDBNull(Me.mvarTerritoryID), ParameterDirection.Input,10 ))
	...
	Public Sub FillData(row as DataRow)
		...
		mvarTerritoryID =  clsCommon.GetValue(row("TerritoryID"), mvarTerritoryID.GetType().FullName)
	End Sub
#End Region 
