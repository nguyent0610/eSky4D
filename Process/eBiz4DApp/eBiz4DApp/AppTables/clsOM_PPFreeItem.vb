...
Public Class clsOM_PPFreeItem
#Region "Constants"
	Private Const PP_OM_PPFreeItem As String = "PP_OM_PPFreeItem"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_PPFreeItem, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_DateTime",DbType.DateTime, clsCommon.GetValueDBNull(me.mvarCrtd_DateTime), ParameterDirection.Input,16 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_PPFreeItem, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BudgetID As System.String, ByVal FreeItemID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal BudgetID As System.String, ByVal FreeItemID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BudgetID", DbType.String, clsCommon.GetValueDBNull(BudgetID), ParameterDirection.Input, 10 ))
			pc.Add(New ParamStruct("@FreeItemID", DbType.String, clsCommon.GetValueDBNull(FreeItemID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_OM_PPFreeItem, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal BudgetID As System.String, ByVal FreeItemID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
