...
Public Class clsOM_TBonusRS
#Region "Constants"
	Private Const PP_OM_TBonusRS As String = "PP_OM_TBonusRS"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_OM_TBonusRS, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,30 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_TBonusRS, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal LevelNbr As System.Int32, ByVal BonusID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal LevelNbr As System.Int32, ByVal BonusID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@LevelNbr", DbType.int32, clsCommon.GetValueDBNull(LevelNbr), ParameterDirection.Input, 4 ))
			pc.Add(New ParamStruct("@BonusID", DbType.String, clsCommon.GetValueDBNull(BonusID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_OM_TBonusRS, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal LevelNbr As System.Int32, ByVal BonusID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
