'-- ------------------------------------------------------------
'-- Class name    :  clsOM_TDisplayCustomer
...
Public Class clsOM_TDisplayCustomer
#Region "Constants"
	Private Const PP_OM_TDisplayCustomer As String = "PP_OM_TDisplayCustomer"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarRate As System.Double
	...
	Private mvarPercentSales As System.Double

	Private mvarPercentImage As System.Double
...
#Region "Public Properties"
	...
	Public Property PercentSales() As System.Double
		Get
			Return mvarPercentSales
		End Get
		Set(ByVal Value As System.Double)
			mvarPercentSales = Value
		End Set
	End Property

	Public Property PercentImage() As System.Double
		Get
			Return mvarPercentImage
		End Get
		Set(ByVal Value As System.Double)
			mvarPercentImage = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Rate", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarRate), ParameterDirection.Input,8 ))
			...
			pc.Add(New ParamStruct("@Territory", DbType.String,clsCommon.GetValueDBNull(Me.mvarTerritory), ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@Zone", DbType.String,clsCommon.GetValueDBNull(Me.mvarZone), ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@PercentSales", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarPercentSales), ParameterDirection.Input,8 ))
			pc.Add(New ParamStruct("@PercentImage", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarPercentImage), ParameterDirection.Input,8 ))
			...
			DAL.ExecPreparedSQL(PP_OM_TDisplayCustomer, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Status",DbType.String, clsCommon.GetValueDBNull(me.mvarStatus), ParameterDirection.Input,2 ))
			 pc.Add(New ParamStruct("@Type",DbType.String, clsCommon.GetValueDBNull(me.mvarType), ParameterDirection.Input,2 ))
			Return (DAL.ExecNonQuery(PP_OM_TDisplayCustomer, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal DisplayID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal DisplayID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@CustID", DbType.String, clsCommon.GetValueDBNull(CustID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@DisplayID", DbType.String, clsCommon.GetValueDBNull(DisplayID), ParameterDirection.Input, 50 ))
			ds = DAL.ExecDataSet(PP_OM_TDisplayCustomer, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal SlsperID As System.String, ByVal CustID As System.String, ByVal DisplayID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
	...
	Public Sub FillData(row as DataRow)
		...
		mvarRate =  clsCommon.GetValue(row("Rate"), mvarRate.GetType().FullName)
		...
		mvarPercentSales =  clsCommon.GetValue(row("PercentSales"), mvarPercentSales.GetType().FullName)
		mvarPercentImage =  clsCommon.GetValue(row("PercentImage"), mvarPercentImage.GetType().FullName)
