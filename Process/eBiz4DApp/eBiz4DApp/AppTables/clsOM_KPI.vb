...
Public Class clsOM_KPI
#Region "Constants"
	Private Const PP_OM_KPI As String = "PP_OM_KPI"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarPC As System.Double

	Private mvarLPPC As System.Double

	Private mvarASO As System.Double
...
#Region "Public Properties"
	...
	Public Property PC() As System.Double
		Get
			Return mvarPC
		End Get
	...
	Public Property ASO() As System.Double
		Get
			Return mvarASO
		End Get
		Set(ByVal Value As System.Double)
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@PC", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarPC), ParameterDirection.Input,8 ))
			pc.Add(New ParamStruct("@LPPC", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarLPPC), ParameterDirection.Input,8 ))
			pc.Add(New ParamStruct("@ASO", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarASO), ParameterDirection.Input,8 ))
			...
			DAL.ExecPreparedSQL(PP_OM_KPI, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_KPI, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal SlsperId As System.String, ByVal CycleNbr As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal SlsperId As System.String, ByVal CycleNbr As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@SlsperId", DbType.String, clsCommon.GetValueDBNull(SlsperId), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@CycleNbr", DbType.String, clsCommon.GetValueDBNull(CycleNbr), ParameterDirection.Input, 6 ))
			ds = DAL.ExecDataSet(PP_OM_KPI, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal SlsperId As System.String, ByVal CycleNbr As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
	...
	Public Sub FillData(row as DataRow)
		...
		mvarPC =  clsCommon.GetValue(row("PC"), mvarPC.GetType().FullName)
		mvarLPPC =  clsCommon.GetValue(row("LPPC"), mvarLPPC.GetType().FullName)
		mvarASO =  clsCommon.GetValue(row("ASO"), mvarASO.GetType().FullName)
