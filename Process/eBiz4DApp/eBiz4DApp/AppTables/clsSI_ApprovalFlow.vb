...
Public Class clsSI_ApprovalFlow
#Region "Constants"
	Private Const PP_SI_ApprovalFlow As String = "PP_SI_ApprovalFlow"
#End Region 

#Region "Member Variables"
	Private mvarAppFolID As System.String

	Private mvarStartStatus As System.String
...
#Region "Public Properties"
	...
	Public Property StartStatus() As System.String
		Get
			Return mvarStartStatus
		End Get
		Set(ByVal Value As System.String)
			mvarStartStatus = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@StartStatus", DbType.String,clsCommon.GetValueDBNull(Me.mvarStartStatus), ParameterDirection.Input,10 ))
			...
			pc.Add(New ParamStruct("@Param01", DbType.String,clsCommon.GetValueDBNull(Me.mvarParam01), ParameterDirection.Input,100 ))
			pc.Add(New ParamStruct("@Param02", DbType.String,clsCommon.GetValueDBNull(Me.mvarParam02), ParameterDirection.Input,100 ))
			pc.Add(New ParamStruct("@Param03", DbType.String,clsCommon.GetValueDBNull(Me.mvarParam03), ParameterDirection.Input,100 ))
			DAL.ExecPreparedSQL(PP_SI_ApprovalFlow, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Param02",DbType.String, clsCommon.GetValueDBNull(me.mvarParam02), ParameterDirection.Input,100 ))
			 pc.Add(New ParamStruct("@Param03",DbType.String, clsCommon.GetValueDBNull(me.mvarParam03), ParameterDirection.Input,100 ))
			Return (DAL.ExecNonQuery(PP_SI_ApprovalFlow, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal AppFolID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal AppFolID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@AppFolID", DbType.String, clsCommon.GetValueDBNull(AppFolID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_SI_ApprovalFlow, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal AppFolID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
	...
	Public Sub FillData(row as DataRow)
		...
		mvarStartStatus =  clsCommon.GetValue(row("StartStatus"), mvarStartStatus.GetType().FullName)
