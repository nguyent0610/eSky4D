...
#Region "Public Methods"
	...
	Public Function Update() as Boolean 
		...
		End Try
	End Function
	Public Function Delete(ByVal TAGID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal TAGID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
	...
	End Sub
	Public Function GetByKey(ByVal TAGID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
