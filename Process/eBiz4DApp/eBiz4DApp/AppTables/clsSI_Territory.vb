...
Public Class clsSI_Territory
#Region "Constants"
	Private Const PP_SI_Territory As String = "PP_SI_Territory"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_SI_Territory, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			 pc.Add(New ParamStruct("@Zone",DbType.String, clsCommon.GetValueDBNull(me.mvarZone), ParameterDirection.Input,10 ))
			Return (DAL.ExecNonQuery(PP_SI_Territory, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	...
	Public Function GetAll(ByVal Territory As System.String) as DataTable 
		...
		Try
			...
			pc.Add(New ParamStruct("@Territory", DbType.String, clsCommon.GetValueDBNull(Territory), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_SI_Territory, CommandType.StoredProcedure, pc,"")
