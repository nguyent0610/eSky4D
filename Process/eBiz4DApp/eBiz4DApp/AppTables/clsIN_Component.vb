...
Public Class clsIN_Component
#Region "Constants"
	Private Const PP_IN_Component As String = "PP_IN_Component"
#End Region 

#Region "Member Variables"
	Private mvarKitID As System.String

	Private mvarComponentID As System.String

	Private mvarComponentQty As System.Double
...
#Region "Public Properties"
	...
	Public Property ComponentID() As System.String
		Get
			Return mvarComponentID
		End Get
		Set(ByVal Value As System.String)
			mvarComponentID = Value
		End Set
	End Property

	Public Property ComponentQty() As System.Double
		Get
			Return mvarComponentQty
		End Get
		Set(ByVal Value As System.Double)
			mvarComponentQty = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@ComponentID", DbType.String,clsCommon.GetValueDBNull(Me.mvarComponentID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@ComponentQty", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarComponentQty), ParameterDirection.Input,8 ))
			...
			DAL.ExecPreparedSQL(PP_IN_Component, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@Crtd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarCrtd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_IN_Component, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal KitID As System.String, ByVal ComponentID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@KitID",DbType.String, clsCommon.GetValueDBNull(KitID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@ComponentID",DbType.String, clsCommon.GetValueDBNull(ComponentID), ParameterDirection.Input,30 ))
			Return (DAL.ExecNonQuery(PP_IN_Component, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal KitID As System.String, ByVal ComponentID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@KitID", DbType.String, clsCommon.GetValueDBNull(KitID), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@ComponentID", DbType.String, clsCommon.GetValueDBNull(ComponentID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_IN_Component, CommandType.StoredProcedure, pc,"")
			Dim keys(1) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("KitID")
			Keys(0) = column
			column = ds.Tables(0).Columns("ComponentID")
			Keys(1) = column
	...
	End Sub
	Public Function GetByKey(ByVal KitID As System.String, ByVal ComponentID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@ComponentID", DbType.String, clsCommon.GetValueDBNull(ComponentID), ParameterDirection.InputOutput, 30 ))
			ds = DAL.ExecDataSet(PP_IN_Component, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		...
		mvarComponentID =  clsCommon.GetValue(row("ComponentID"), mvarComponentID.GetType().FullName)
		mvarComponentQty =  clsCommon.GetValue(row("ComponentQty"), mvarComponentQty.GetType().FullName)
