...
#Region "Member Variables"
	...
	Private mvarAutoSlsperID As System.Boolean

	Private mvarHiddenHierarchy As System.Boolean
...
#Region "Public Properties"
	...
	Public Property AutoSlsperID() As System.Boolean
		Get
			Return mvarAutoSlsperID
		End Get
		Set(ByVal Value As System.Boolean)
			mvarAutoSlsperID = Value
		End Set
	End Property

	Public Property HiddenHierarchy() As System.Boolean
		Get
			Return mvarHiddenHierarchy
		End Get
		Set(ByVal Value As System.Boolean)
			mvarHiddenHierarchy = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@AutoSlsperID", DbType.Boolean,clsCommon.GetValueDBNull(Me.mvarAutoSlsperID), ParameterDirection.Input,2 ))
			pc.Add(New ParamStruct("@HiddenHierarchy", DbType.Boolean,clsCommon.GetValueDBNull(Me.mvarHiddenHierarchy), ParameterDirection.Input,2 ))
	...
	Public Sub Reset()
		...
		mvarAutoSlsperID = False
		mvarHiddenHierarchy = False
	End Sub
	...
	Public Sub FillData(row as DataRow)
		...
		mvarAutoSlsperID =  clsCommon.GetValue(row("AutoSlsperID"), mvarAutoSlsperID.GetType().FullName)
		mvarHiddenHierarchy =  clsCommon.GetValue(row("HiddenHierarchy"), mvarHiddenHierarchy.GetType().FullName)
	End Sub
#End Region 
