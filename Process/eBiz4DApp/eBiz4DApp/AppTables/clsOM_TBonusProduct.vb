'-- ------------------------------------------------------------
'-- Class name    :  clsOM_TBonusProduct
...
Public Class clsOM_TBonusProduct
#Region "Constants"
	Private Const PP_OM_TBonusProduct As String = "PP_OM_TBonusProduct"
#End Region 

#Region "Member Variables"
	Private mvarProductID As System.String

	Private mvarBonusID As System.String

	Private mvarProductType As System.String
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@ProductID", DbType.String,clsCommon.GetValueDBNull(Me.mvarProductID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@BonusID", DbType.String,clsCommon.GetValueDBNull(Me.mvarBonusID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@ProductType", DbType.String,clsCommon.GetValueDBNull(Me.mvarProductType), ParameterDirection.Input,2 ))
			...
			DAL.ExecPreparedSQL(PP_OM_TBonusProduct, CommandType.StoredProcedure, pc,"")
		Me.mvarProductID = clsCommon.GetValue(pc.Item("@ProductID").Value, mvarProductID.GetType().FullName)
		Return (Me.mvarProductID <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,30 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_TBonusProduct, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal ProductID As System.String, ByVal BonusID As System.String, ByVal ProductType As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@ProductID",DbType.String, clsCommon.GetValueDBNull(ProductID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@BonusID",DbType.String, clsCommon.GetValueDBNull(BonusID), ParameterDirection.Input,30 ))
			pc.Add(New ParamStruct("@ProductType",DbType.String, clsCommon.GetValueDBNull(ProductType), ParameterDirection.Input,2 ))
			Return (DAL.ExecNonQuery(PP_OM_TBonusProduct, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function GetAll(ByVal ProductID As System.String, ByVal BonusID As System.String, ByVal ProductType As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@BonusID", DbType.String, clsCommon.GetValueDBNull(BonusID), ParameterDirection.Input, 30 ))
			pc.Add(New ParamStruct("@ProductType", DbType.String, clsCommon.GetValueDBNull(ProductType), ParameterDirection.Input, 2 ))
			ds = DAL.ExecDataSet(PP_OM_TBonusProduct, CommandType.StoredProcedure, pc,"")
			Dim keys(2) As DataColumn
			Dim column As DataColumn
			column = ds.Tables(0).Columns("ProductID")
			Keys(0) = column
			column = ds.Tables(0).Columns("BonusID")
			Keys(1) = column
			column = ds.Tables(0).Columns("ProductType")
			Keys(2) = column
	...
	End Function
	Public Sub Reset()
		mvarProductID = String.Empty
		mvarBonusID = String.Empty
		mvarProductType = String.Empty
	...
	End Sub
	Public Function GetByKey(ByVal ProductID As System.String, ByVal BonusID As System.String, ByVal ProductType As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
			pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input,50 ))
			pc.Add(New ParamStruct("@ProductID", DbType.String, clsCommon.GetValueDBNull(ProductID), ParameterDirection.InputOutput, 30 ))
			pc.Add(New ParamStruct("@BonusID", DbType.String, clsCommon.GetValueDBNull(BonusID), ParameterDirection.InputOutput, 30 ))
			pc.Add(New ParamStruct("@ProductType", DbType.String, clsCommon.GetValueDBNull(ProductType), ParameterDirection.InputOutput, 2 ))
			ds = DAL.ExecDataSet(PP_OM_TBonusProduct, CommandType.StoredProcedure, pc,"")
			me.Reset()
	...
	Public Sub FillData(row as DataRow)
		mvarProductID =  clsCommon.GetValue(row("ProductID"), mvarProductID.GetType().FullName)
		mvarBonusID =  clsCommon.GetValue(row("BonusID"), mvarBonusID.GetType().FullName)
		mvarProductType =  clsCommon.GetValue(row("ProductType"), mvarProductType.GetType().FullName)
