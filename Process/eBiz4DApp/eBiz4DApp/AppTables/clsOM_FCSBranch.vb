...
Public Class clsOM_FCSBranch
#Region "Constants"
	Private Const PP_OM_FCSBranch As String = "PP_OM_FCSBranch"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarSellInKPI As System.Double
...
#Region "Public Properties"
	...
	Public Property SellInKPI() As System.Double
		Get
			Return mvarSellInKPI
		End Get
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@SellInKPI", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarSellInKPI), ParameterDirection.Input,8 ))
			...
			DAL.ExecPreparedSQL(PP_OM_FCSBranch, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_FCSBranch, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal BranchID As System.String, ByVal FCSDate As System.DateTime, ByVal ClassID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal BranchID As System.String, ByVal FCSDate As System.DateTime, ByVal ClassID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@FCSDate", DbType.DateTime, clsCommon.GetValueDBNull(FCSDate), ParameterDirection.Input, 16 ))
			pc.Add(New ParamStruct("@ClassID", DbType.String, clsCommon.GetValueDBNull(ClassID), ParameterDirection.Input, 10 ))
			ds = DAL.ExecDataSet(PP_OM_FCSBranch, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal BranchID As System.String, ByVal FCSDate As System.DateTime, ByVal ClassID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
	...
	Public Sub FillData(row as DataRow)
		...
		mvarSellInKPI =  clsCommon.GetValue(row("SellInKPI"), mvarSellInKPI.GetType().FullName)
