'-- ------------------------------------------------------------
'-- Class name    :  clsSI_SrvQuestionCpny
...
Public Class clsSI_SrvQuestionCpny
#Region "Constants"
	Private Const PP_SI_SrvQuestionCpny As String = "PP_SI_SrvQuestionCpny"
#End Region 
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			DAL.ExecPreparedSQL(PP_SI_SrvQuestionCpny, CommandType.StoredProcedure, pc,"")
		Me.mvarListID = clsCommon.GetValue(pc.Item("@ListID").Value, mvarListID.GetType().FullName)
		Return (Me.mvarListID <> String.Empty )
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_SI_SrvQuestionCpny, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal ListID As System.String, ByVal CpnyID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal ListID As System.String, ByVal CpnyID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@ListID", DbType.String, clsCommon.GetValueDBNull(ListID), ParameterDirection.Input, 50 ))
			pc.Add(New ParamStruct("@CpnyID", DbType.String, clsCommon.GetValueDBNull(CpnyID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_SI_SrvQuestionCpny, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal ListID As System.String, ByVal CpnyID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
