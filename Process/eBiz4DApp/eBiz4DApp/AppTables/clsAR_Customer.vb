...
#Region "Member Variables"
	...
	Private mvarEstablishDate As System.String

	Private mvarBirthdate As System.String
...
#Region "Public Properties"
	...
	Public Property EstablishDate() As System.String
		Get
			Return mvarEstablishDate
		End Get
		Set(ByVal Value As System.String)
			mvarEstablishDate = Value
		End Set
	End Property
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@EstablishDate", DbType.String,clsCommon.GetValueDBNull(Me.mvarEstablishDate), ParameterDirection.Input,10 ))
			pc.Add(New ParamStruct("@Birthdate", DbType.String,clsCommon.GetValueDBNull(Me.mvarBirthdate), ParameterDirection.Input,10 ))
	...
	Public Sub Reset()
		...
		mvarEstablishDate = String.Empty
		mvarBirthdate = String.Empty
	End Sub
	...
	Public Sub FillData(row as DataRow)
		...
		mvarEstablishDate =  clsCommon.GetValue(row("EstablishDate"), mvarEstablishDate.GetType().FullName)
		mvarBirthdate =  clsCommon.GetValue(row("Birthdate"), mvarBirthdate.GetType().FullName)
	End Sub
#End Region 
