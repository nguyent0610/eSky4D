...
Public Class clsOM_DiscItem
#Region "Constants"
	Private Const PP_OM_DiscItem As String = "PP_OM_DiscItem"
#End Region 
...
#Region "Member Variables"
	...
	Private mvarBundleAmt As System.Double

	Private mvarBundleNbr As System.Int16

	Private mvarBundleOrItem As System.String

	Private mvarBundleQty As System.Double
...
#Region "Public Properties"
	...
	Public Property BundleAmt() As System.Double
		Get
			Return mvarBundleAmt
		End Get
	...
	Public Property BundleNbr() As System.Int16
		Get
			Return mvarBundleNbr
		End Get
		Set(ByVal Value As System.Int16)
			mvarBundleNbr = Value
		End Set
	...
	Public Property BundleOrItem() As System.String
		Get
			Return mvarBundleOrItem
		End Get
		Set(ByVal Value As System.String)
			mvarBundleOrItem = Value
		End Set
	End Property

	Public Property BundleQty() As System.Double
		Get
			Return mvarBundleQty
		End Get
		Set(ByVal Value As System.Double)
			mvarBundleQty = Value
		End Set
...
#Region "Public Methods"
	Public Function Add() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@BundleAmt", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarBundleAmt), ParameterDirection.Input,8 ))
			pc.Add(New ParamStruct("@BundleNbr", DbType.int16,clsCommon.GetValueDBNull(Me.mvarBundleNbr), ParameterDirection.Input,2 ))
			pc.Add(New ParamStruct("@BundleOrItem", DbType.String,clsCommon.GetValueDBNull(Me.mvarBundleOrItem), ParameterDirection.Input,1 ))
			pc.Add(New ParamStruct("@BundleQty", DbType.Decimal,clsCommon.GetValueDBNull(Me.mvarBundleQty), ParameterDirection.Input,8 ))
			...
			DAL.ExecPreparedSQL(PP_OM_DiscItem, CommandType.StoredProcedure, pc,"")
	...
	Public Function Update() as Boolean 
		...
		Try
			...
			pc.Add(New ParamStruct("@Action", DbType.String, "Update", ParameterDirection.Input,50 ))
			 ...
			 pc.Add(New ParamStruct("@LUpd_User",DbType.String, clsCommon.GetValueDBNull(me.mvarLUpd_User), ParameterDirection.Input,10 ))
			 pc.Add(New ParamStruct("@tstamp",DbType.String, clsCommon.GetValueDBNull(me.mvartstamp), ParameterDirection.Input,18 ))
			Return (DAL.ExecNonQuery(PP_OM_DiscItem, CommandType.StoredProcedure, pc,"") > 0)
		Catch ex As Exception
			Throw ex 
		End Try
	End Function
	Public Function Delete(ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal InvtID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
		...
		End Try
	End Function
	Public Function GetAll(ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal InvtID As System.String) as DataTable 
		Dim DAL As DataAccess = m_Dal
		Try
			Dim pc As New ParamCollection
			...
			pc.Add(New ParamStruct("@DiscSeq", DbType.String, clsCommon.GetValueDBNull(DiscSeq), ParameterDirection.Input, 10 ))
			pc.Add(New ParamStruct("@InvtID", DbType.String, clsCommon.GetValueDBNull(InvtID), ParameterDirection.Input, 30 ))
			ds = DAL.ExecDataSet(PP_OM_DiscItem, CommandType.StoredProcedure, pc,"")
	...
	End Sub
	Public Function GetByKey(ByVal DiscID As System.String, ByVal DiscSeq As System.String, ByVal InvtID As System.String) as Boolean 
		Dim DAL As DataAccess = m_Dal
		Dim ds As New DataSet 
		Try
			Dim pc As New ParamCollection
	...
	Public Sub FillData(row as DataRow)
		...
		mvarBundleAmt =  clsCommon.GetValue(row("BundleAmt"), mvarBundleAmt.GetType().FullName)
		mvarBundleNbr =  clsCommon.GetValue(row("BundleNbr"), mvarBundleNbr.GetType().FullName)
		mvarBundleOrItem =  clsCommon.GetValue(row("BundleOrItem"), mvarBundleOrItem.GetType().FullName)
		mvarBundleQty =  clsCommon.GetValue(row("BundleQty"), mvarBundleQty.GetType().FullName)
