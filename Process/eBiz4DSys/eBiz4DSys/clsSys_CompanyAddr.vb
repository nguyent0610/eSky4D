...
Public Class clsSys_CompanyAddr
#Region "Constants"
    Private Const PP_Sys_CompanyAddr As String = "PP_Sys_CompanyAddr"
#End Region
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@Addr1", DbType.String, clsCommon.GetValueDBNull(Me.mvarAddr1), ParameterDirection.Input, 250))
            pc.Add(New ParamStruct("@Addr2", DbType.String, clsCommon.GetValueDBNull(Me.mvarAddr2), ParameterDirection.Input, 250))
            pc.Add(New ParamStruct("@Attn", DbType.String, clsCommon.GetValueDBNull(Me.mvarAttn), ParameterDirection.Input, 250))
            ...
            pc.Add(New ParamStruct("@Name", DbType.String, clsCommon.GetValueDBNull(Me.mvarName), ParameterDirection.Input, 250))
            ...
            pc.Add(New ParamStruct("@State", DbType.String, clsCommon.GetValueDBNull(Me.mvarState), ParameterDirection.Input, 4))
            ...
            DAL.ExecPreparedSQL(PP_Sys_CompanyAddr, CommandType.StoredProcedure, pc, "")
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@LUpd_User", DbType.String, clsCommon.GetValueDBNull(Me.mvarLUpd_User), ParameterDirection.Input, 10))
            pc.Add(New ParamStruct("@tstamp", DbType.String, clsCommon.GetValueDBNull(Me.mvartstamp), ParameterDirection.Input, 18))
            Return (DAL.ExecNonQuery(PP_Sys_CompanyAddr, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function Delete(ByVal CpnyID As System.String, ByVal AddrID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
        ...
        End Try
    End Function
    Public Function GetAll(ByVal CpnyID As System.String, ByVal AddrID As System.String) As DataTable
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@CpnyID", DbType.String, clsCommon.GetValueDBNull(CpnyID), ParameterDirection.Input, 10))
            pc.Add(New ParamStruct("@AddrID", DbType.String, clsCommon.GetValueDBNull(AddrID), ParameterDirection.Input, 10))
            ds = DAL.ExecDataSet(PP_Sys_CompanyAddr, CommandType.StoredProcedure, pc, "")
    ...
    End Sub
    Public Function GetByKey(ByVal CpnyID As System.String, ByVal AddrID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Dim ds As New DataSet
        Try
            Dim pc As New ParamCollection
