...
Public Class clsSYS_Role
#Region "Constants"
    Private Const PP_SYS_Role As String = "PP_SYS_Role"
#End Region

#Region "Member Variables"
    Private mvarRoleID As System.String

    Private mvarDesc As System.String
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@RoleID", DbType.String, clsCommon.GetValueDBNull(Me.mvarRoleID), ParameterDirection.Input, 50))
            pc.Add(New ParamStruct("@Desc", DbType.String, clsCommon.GetValueDBNull(Me.mvarDesc), ParameterDirection.Input, 250))
            ...
            DAL.ExecPreparedSQL(PP_SYS_Role, CommandType.StoredProcedure, pc, "")
            Me.mvarRoleID = clsCommon.GetValue(pc.Item("@RoleID").Value, mvarRoleID.GetType().FullName)
            Return (Me.mvarRoleID <> String.Empty)
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@LUpd_User", DbType.String, clsCommon.GetValueDBNull(Me.mvarLUpd_User), ParameterDirection.Input, 10))
            pc.Add(New ParamStruct("@tstamp", DbType.String, clsCommon.GetValueDBNull(Me.mvartstamp), ParameterDirection.Input, 18))
            Return (DAL.ExecNonQuery(PP_SYS_Role, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function Delete(ByVal RoleID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input, 50))
            pc.Add(New ParamStruct("@RoleID", DbType.String, clsCommon.GetValueDBNull(RoleID), ParameterDirection.Input, 50))
            Return (DAL.ExecNonQuery(PP_SYS_Role, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function GetAll(ByVal RoleID As System.String) As DataTable
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@RoleID", DbType.String, clsCommon.GetValueDBNull(RoleID), ParameterDirection.Input, 50))
            ds = DAL.ExecDataSet(PP_SYS_Role, CommandType.StoredProcedure, pc, "")
    ...
    End Sub
    Public Function GetByKey(ByVal RoleID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Dim ds As New DataSet
        Try
            Dim pc As New ParamCollection
            pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input, 50))
            pc.Add(New ParamStruct("@RoleID", DbType.String, clsCommon.GetValueDBNull(RoleID), ParameterDirection.InputOutput, 50))
            ds = DAL.ExecDataSet(PP_SYS_Role, CommandType.StoredProcedure, pc, "")
            Me.Reset()
    ...
    Public Sub FillData(row As DataRow)
        ...
        mvarDesc = clsCommon.GetValue(row("Desc"), mvarDesc.GetType().FullName)
