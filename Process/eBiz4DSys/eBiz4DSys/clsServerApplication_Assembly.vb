'-- ------------------------------------------------------------
'-- Class name    :  clsServerApplication_Assembly
...
Public Class clsServerApplication_Assembly
#Region "Constants"
    Private Const PP_ServerApplication_Assembly As String = "PP_ServerApplication_Assembly"
#End Region
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@AssemblyName", DbType.String, clsCommon.GetValueDBNull(Me.mvarAssemblyName), ParameterDirection.Input, 100))
            ...
            DAL.ExecPreparedSQL(PP_ServerApplication_Assembly, CommandType.StoredProcedure, pc, "")
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@LUpd_User", DbType.String, clsCommon.GetValueDBNull(Me.mvarLUpd_User), ParameterDirection.Input, 20))
            pc.Add(New ParamStruct("@tstamp", DbType.String, clsCommon.GetValueDBNull(Me.mvartstamp), ParameterDirection.Input, 18))
            Return (DAL.ExecNonQuery(PP_ServerApplication_Assembly, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function GetAll(ByVal Type As System.String) As DataTable
        ...
        Try
            ...
            pc.Add(New ParamStruct("@Type", DbType.String, clsCommon.GetValueDBNull(Type), ParameterDirection.Input, 20))
            ds = DAL.ExecDataSet(PP_ServerApplication_Assembly, CommandType.StoredProcedure, pc, "")
