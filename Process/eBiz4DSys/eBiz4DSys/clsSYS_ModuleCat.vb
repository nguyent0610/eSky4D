...
Public Class clsSYS_ModuleCat
#Region "Constants"
    Private Const PP_SYS_ModuleCat As String = "PP_SYS_ModuleCat"
#End Region
...
#Region "Member Variables"
    ...
    Private mvarSort As System.Int16
...
#Region "Public Properties"
    ...
    Public Property Sort() As System.Int16
        Get
            Return mvarSort
        End Get
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@Sort", DbType.Int16, clsCommon.GetValueDBNull(Me.mvarSort), ParameterDirection.Input, 2))
            ...
            DAL.ExecPreparedSQL(PP_SYS_ModuleCat, CommandType.StoredProcedure, pc, "")
            Me.mvarCatID = clsCommon.GetValue(pc.Item("@CatID").Value, mvarCatID.GetType().FullName)
            Return (Me.mvarCatID <> String.Empty)
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@LUpd_User", DbType.String, clsCommon.GetValueDBNull(Me.mvarLUpd_User), ParameterDirection.Input, 10))
            pc.Add(New ParamStruct("@tstamp", DbType.String, clsCommon.GetValueDBNull(Me.mvartstamp), ParameterDirection.Input, 18))
            Return (DAL.ExecNonQuery(PP_SYS_ModuleCat, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function Delete(ByVal CatID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input, 50))
            pc.Add(New ParamStruct("@CatID", DbType.String, clsCommon.GetValueDBNull(CatID), ParameterDirection.Input, 10))
            Return (DAL.ExecNonQuery(PP_SYS_ModuleCat, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function GetAll(ByVal CatID As System.String) As DataTable
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@CatID", DbType.String, clsCommon.GetValueDBNull(CatID), ParameterDirection.Input, 10))
            ds = DAL.ExecDataSet(PP_SYS_ModuleCat, CommandType.StoredProcedure, pc, "")
            Dim keys(0) As DataColumn
            Dim column As DataColumn
            column = ds.Tables(0).Columns("CatID")
            keys(0) = column
    ...
    End Sub
    Public Function GetByKey(ByVal CatID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Dim ds As New DataSet
        Try
            Dim pc As New ParamCollection
            pc.Add(New ParamStruct("@Action", DbType.String, "GetData_ByKey", ParameterDirection.Input, 50))
            pc.Add(New ParamStruct("@CatID", DbType.String, clsCommon.GetValueDBNull(CatID), ParameterDirection.InputOutput, 10))
            ds = DAL.ExecDataSet(PP_SYS_ModuleCat, CommandType.StoredProcedure, pc, "")
            Me.Reset()
    ...
    Public Sub FillData(row As DataRow)
        ...
        mvarSort = clsCommon.GetValue(row("Sort"), mvarSort.GetType().FullName)
