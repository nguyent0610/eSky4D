'-- ------------------------------------------------------------
'-- Class name    :  clsServerApplication_ExportTable
...
Public Class clsServerApplication_ExportTable
#Region "Constants"
    Private Const PP_ServerApplication_ExportTable As String = "PP_ServerApplication_ExportTable"
#End Region
...
#Region "Member Variables"
    ...
    Private mvarColumns As System.String

    Private mvarMode As System.String
    ...
    Private mvarFilter As System.String
...
#Region "Public Properties"
    ...
    Public Property Columns() As System.String
        Get
            Return mvarColumns
        End Get
        Set(ByVal Value As System.String)
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@Columns", DbType.String, clsCommon.GetValueDBNull(Me.mvarColumns), ParameterDirection.Input, 2147483647))
            pc.Add(New ParamStruct("@Mode", DbType.String, clsCommon.GetValueDBNull(Me.mvarMode), ParameterDirection.Input, 5))
            ...
            pc.Add(New ParamStruct("@Filter", DbType.String, clsCommon.GetValueDBNull(Me.mvarFilter), ParameterDirection.Input, 500))
            pc.Add(New ParamStruct("@Index", DbType.Int32, clsCommon.GetValueDBNull(Me.mvarIndex), ParameterDirection.Input, 4))
            DAL.ExecPreparedSQL(PP_ServerApplication_ExportTable, CommandType.StoredProcedure, pc, "")
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@Filter", DbType.String, clsCommon.GetValueDBNull(Me.mvarFilter), ParameterDirection.Input, 500))
            pc.Add(New ParamStruct("@Index", DbType.Int32, clsCommon.GetValueDBNull(Me.mvarIndex), ParameterDirection.Input, 4))
            Return (DAL.ExecNonQuery(PP_ServerApplication_ExportTable, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function GetAll(ByVal ID As System.String, ByVal TableName As System.String) As DataTable
        ...
        Try
            ...
            pc.Add(New ParamStruct("@ID", DbType.String, clsCommon.GetValueDBNull(ID), ParameterDirection.Input, 50))
            pc.Add(New ParamStruct("@TableName", DbType.String, clsCommon.GetValueDBNull(TableName), ParameterDirection.Input, 250))
            ds = DAL.ExecDataSet(PP_ServerApplication_ExportTable, CommandType.StoredProcedure, pc, "")
    ...
    Public Sub Reset()
        ...
        mvarColumns = String.Empty
        mvarMode = String.Empty
    ...
    Public Sub FillData(row As DataRow)
        ...
        mvarMode = clsCommon.GetValue(row("Mode"), mvarMode.GetType().FullName)
