'-- ------------------------------------------------------------
'-- Class name    :  clsSYS_OLapTemplate
...
Public Class clsSYS_OLapTemplate
#Region "Constants"
    Private Const PP_SYS_OLapTemplate As String = "PP_SYS_OLapTemplate"
#End Region
...
#Region "Member Variables"
    ...
    Private mvarTempID As System.Int32

    Private mvarDescr As System.String

    Private mvarTempData As System.String

    Private mvarDefault As System.Boolean
...
#Region "Public Properties"
    ...
    Public Property TempData() As System.String
        Get
            Return mvarTempData
        End Get
        Set(ByVal Value As System.String)
    ...
    Public Property Default1() As System.Boolean
        Get
            Return mvarDefault
        End Get
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@TempID", DbType.Int32, clsCommon.GetValueDBNull(Me.mvarTempID), ParameterDirection.Input, 4))
            pc.Add(New ParamStruct("@Descr", DbType.String, clsCommon.GetValueDBNull(Me.mvarDescr), ParameterDirection.Input, 250))
            pc.Add(New ParamStruct("@TempData", DbType.String, clsCommon.GetValueDBNull(Me.mvarTempData), ParameterDirection.Input, Nothing))
            pc.Add(New ParamStruct("@Default", DbType.Boolean, clsCommon.GetValueDBNull(Me.mvarDefault), ParameterDirection.Input, 2))
            ...
            DAL.ExecPreparedSQL(PP_SYS_OLapTemplate, CommandType.StoredProcedure, pc, "")
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@LUpd_User", DbType.String, clsCommon.GetValueDBNull(Me.mvarLUpd_User), ParameterDirection.Input, 10))
            pc.Add(New ParamStruct("@tstamp", DbType.String, clsCommon.GetValueDBNull(Me.mvartstamp), ParameterDirection.Input, 18))
            Return (DAL.ExecNonQuery(PP_SYS_OLapTemplate, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function Delete(ByVal ReportNbr As System.String, ByVal ReportViewerNbr As System.Int32, ByVal TempID As System.Int32) As Boolean
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@TempID", DbType.Int32, clsCommon.GetValueDBNull(TempID), ParameterDirection.Input, 4))
            Return (DAL.ExecNonQuery(PP_SYS_OLapTemplate, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function GetAll(ByVal ReportNbr As System.String, ByVal ReportViewerNbr As System.Int32, ByVal TempID As System.Int32) As DataTable
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@ReportViewerNbr", DbType.Int32, clsCommon.GetValueDBNull(ReportViewerNbr), ParameterDirection.Input, 4))
            pc.Add(New ParamStruct("@TempID", DbType.Int32, clsCommon.GetValueDBNull(TempID), ParameterDirection.Input, 4))
            ds = DAL.ExecDataSet(PP_SYS_OLapTemplate, CommandType.StoredProcedure, pc, "")
            ...
            keys(1) = column
            column = ds.Tables(0).Columns("TempID")
            keys(2) = column
    ...
    End Sub
    Public Function GetByKey(ByVal ReportNbr As System.String, ByVal ReportViewerNbr As System.Int32, ByVal TempID As System.Int32) As Boolean
        Dim DAL As DataAccess = m_Dal
        Dim ds As New DataSet
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@TempID", DbType.Int32, clsCommon.GetValueDBNull(TempID), ParameterDirection.InputOutput, 4))
            ds = DAL.ExecDataSet(PP_SYS_OLapTemplate, CommandType.StoredProcedure, pc, "")
            Me.Reset()
    ...
    Public Sub FillData(row As DataRow)
        ...
        mvarTempID = clsCommon.GetValue(row("TempID"), mvarTempID.GetType().FullName)
        mvarDescr = clsCommon.GetValue(row("Descr"), mvarDescr.GetType().FullName)
        mvarTempData = clsCommon.GetValue(row("TempData"), mvarTempData.GetType().FullName)
        mvarDefault = clsCommon.GetValue(row("Default"), mvarDefault.GetType().FullName)
