...
Public Class clsSYS_ScreenCat
#Region "Constants"
    Private Const PP_SYS_ScreenCat As String = "PP_SYS_ScreenCat"
#End Region
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            DAL.ExecPreparedSQL(PP_SYS_ScreenCat, CommandType.StoredProcedure, pc, "")
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@LUpd_User", DbType.String, clsCommon.GetValueDBNull(Me.mvarLUpd_User), ParameterDirection.Input, 10))
            pc.Add(New ParamStruct("@tstamp", DbType.String, clsCommon.GetValueDBNull(Me.mvartstamp), ParameterDirection.Input, 18))
            Return (DAL.ExecNonQuery(PP_SYS_ScreenCat, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function GetAll(ByVal CatID As System.String) As DataTable
        ...
        Try
            ...
            pc.Add(New ParamStruct("@CatID", DbType.String, clsCommon.GetValueDBNull(CatID), ParameterDirection.Input, 10))
            ds = DAL.ExecDataSet(PP_SYS_ScreenCat, CommandType.StoredProcedure, pc, "")
