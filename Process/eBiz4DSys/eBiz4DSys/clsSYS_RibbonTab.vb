...
Public Class clsSYS_RibbonTab
#Region "Constants"
    Private Const PP_SYS_RibbonTab As String = "PP_SYS_RibbonTab"
#End Region
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            DAL.ExecPreparedSQL(PP_SYS_RibbonTab, CommandType.StoredProcedure, pc, "")
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@LUpd_User", DbType.String, clsCommon.GetValueDBNull(Me.mvarLUpd_User), ParameterDirection.Input, 10))
            pc.Add(New ParamStruct("@tstamp", DbType.String, clsCommon.GetValueDBNull(Me.mvartstamp), ParameterDirection.Input, 18))
            Return (DAL.ExecNonQuery(PP_SYS_RibbonTab, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function Delete(ByVal TabID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
        ...
        End Try
    End Function
    Public Function GetAll(ByVal TabID As System.String) As DataTable
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@TabID", DbType.String, clsCommon.GetValueDBNull(TabID), ParameterDirection.Input, 10))
            ds = DAL.ExecDataSet(PP_SYS_RibbonTab, CommandType.StoredProcedure, pc, "")
    ...
    End Sub
    Public Function GetByKey(ByVal TabID As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Dim ds As New DataSet
        Try
            Dim pc As New ParamCollection
