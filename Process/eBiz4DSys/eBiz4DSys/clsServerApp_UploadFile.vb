'-- ------------------------------------------------------------
'-- Class name    :  clsServerApp_UploadFile
...
Public Class clsServerApp_UploadFile
#Region "Constants"
    Private Const PP_ServerApp_UploadFile As String = "PP_ServerApp_UploadFile"
#End Region
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@FileName", DbType.String, clsCommon.GetValueDBNull(Me.mvarFileName), ParameterDirection.Input, 100))
            pc.Add(New ParamStruct("@Path", DbType.String, clsCommon.GetValueDBNull(Me.mvarPath), ParameterDirection.Input, 1000))
            ...
            DAL.ExecPreparedSQL(PP_ServerApp_UploadFile, CommandType.StoredProcedure, pc, "")
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@LUpd_User", DbType.String, clsCommon.GetValueDBNull(Me.mvarLUpd_User), ParameterDirection.Input, 15))
            pc.Add(New ParamStruct("@tstamp", DbType.String, clsCommon.GetValueDBNull(Me.mvartstamp), ParameterDirection.Input, 18))
            Return (DAL.ExecNonQuery(PP_ServerApp_UploadFile, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function Delete(ByVal TaskID As System.Int32, ByVal FileName As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            pc.Add(New ParamStruct("@Action", DbType.String, "Delete", ParameterDirection.Input, 50))
            pc.Add(New ParamStruct("@TaskID", DbType.Int32, clsCommon.GetValueDBNull(TaskID), ParameterDirection.Input, 4))
            pc.Add(New ParamStruct("@FileName", DbType.String, clsCommon.GetValueDBNull(FileName), ParameterDirection.Input, 100))
            Return (DAL.ExecNonQuery(PP_ServerApp_UploadFile, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function GetAll(ByVal TaskID As System.Int32, ByVal FileName As System.String) As DataTable
        Dim DAL As DataAccess = m_Dal
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@TaskID", DbType.Int32, clsCommon.GetValueDBNull(TaskID), ParameterDirection.Input, 4))
            pc.Add(New ParamStruct("@FileName", DbType.String, clsCommon.GetValueDBNull(FileName), ParameterDirection.Input, 100))
            ds = DAL.ExecDataSet(PP_ServerApp_UploadFile, CommandType.StoredProcedure, pc, "")
    ...
    End Sub
    Public Function GetByKey(ByVal TaskID As System.Int32, ByVal FileName As System.String) As Boolean
        Dim DAL As DataAccess = m_Dal
        Dim ds As New DataSet
        Try
            Dim pc As New ParamCollection
            ...
            pc.Add(New ParamStruct("@FileName", DbType.String, clsCommon.GetValueDBNull(FileName), ParameterDirection.InputOutput, 100))
            ds = DAL.ExecDataSet(PP_ServerApp_UploadFile, CommandType.StoredProcedure, pc, "")
            Me.Reset()
