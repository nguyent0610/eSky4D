'-- ------------------------------------------------------------
'-- Class name    :  clsServerApplication_Import
...
Public Class clsServerApplication_Import
#Region "Constants"
    Private Const PP_ServerApplication_Import As String = "PP_ServerApplication_Import"
#End Region
...
#Region "Public Methods"
    Public Function Add() As Boolean
        ...
        Try
            ...
            DAL.ExecPreparedSQL(PP_ServerApplication_Import, CommandType.StoredProcedure, pc, "")
    ...
    Public Function Update() As Boolean
        ...
        Try
            ...
            pc.Add(New ParamStruct("@DbUserName", DbType.String, clsCommon.GetValueDBNull(Me.mvarDbUserName), ParameterDirection.Input, 50))
            pc.Add(New ParamStruct("@DbPassword", DbType.String, clsCommon.GetValueDBNull(Me.mvarDbPassword), ParameterDirection.Input, 50))
            Return (DAL.ExecNonQuery(PP_ServerApplication_Import, CommandType.StoredProcedure, pc, "") > 0)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function GetAll(ByVal ID As System.String) As DataTable
        ...
        Try
            ...
            pc.Add(New ParamStruct("@ID", DbType.String, clsCommon.GetValueDBNull(ID), ParameterDirection.Input, 50))
            ds = DAL.ExecDataSet(PP_ServerApplication_Import, CommandType.StoredProcedure, pc, "")
