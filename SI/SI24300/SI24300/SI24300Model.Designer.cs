...
namespace SI24300
{
    ...
    /// </summary>
    public partial class SI24300Entities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new SI24300Entities object using the connection string found in the 'SI24300Entities' section of the application configuration file.
        /// </summary>
        public SI24300Entities() : base("name=SI24300Entities", "SI24300Entities")
        {
        ...
        /// <summary>
        /// Initialize a new SI24300Entities object.
        /// </summary>
        public SI24300Entities(string connectionString) : base(connectionString, "SI24300Entities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new SI24300Entities object.
        /// </summary>
        public SI24300Entities(EntityConnection connection) : base(connection, "SI24300Entities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        public ObjectResult<SI24300_pgSI_Ward_Result> SI24300_pgSI_Ward(global::System.String userName, global::System.String cpnyID, Nullable<global::System.Int16> langID)
        {
            ...
            return base.ExecuteFunction<SI24300_pgSI_Ward_Result>("SI24300_pgSI_Ward", userNameParameter, cpnyIDParameter, langIDParameter);
        }
        ...
        public ObjectResult<SI24300_pcDistrict_Result> SI24300_pcDistrict(global::System.String userName, global::System.String cpnyID, Nullable<global::System.Int16> langID, global::System.String state)
        {
            ObjectParameter userNameParameter;
            if (userName != null)
            {
            ...
            return base.ExecuteFunction<SI24300_pcDistrict_Result>("SI24300_pcDistrict", userNameParameter, cpnyIDParameter, langIDParameter, stateParameter);
        }
        ...
        /// <param name="cpnyID">No Metadata Documentation available.</param>
        /// <param name="langID">No Metadata Documentation available.</param>
        public ObjectResult<SI24300_pcState_Result> SI24300_pcState(global::System.String userName, global::System.String cpnyID, Nullable<global::System.Int16> langID)
        {
            ObjectParameter userNameParameter;
            if (userName != null)
            {
            ...
            return base.ExecuteFunction<SI24300_pcState_Result>("SI24300_pcState", userNameParameter, cpnyIDParameter, langIDParameter);
        }
        ...
        /// <param name="userName">No Metadata Documentation available.</param>
        /// <param name="langID">No Metadata Documentation available.</param>
        /// <param name="ward">No Metadata Documentation available.</param>
        public ObjectResult<Nullable<global::System.Int32>> SI24300_pdCheckbeforedelete(global::System.String cpnyID, global::System.String userName, Nullable<global::System.Int16> langID, global::System.String ward)
        {
            ObjectParameter cpnyIDParameter;
            if (cpnyID != null)
            {
            ...
            ObjectParameter wardParameter;
            if (ward != null)
            {
                wardParameter = new ObjectParameter("Ward", ward);
            }
            else
            {
                wardParameter = new ObjectParameter("Ward", typeof(global::System.String));
            }
    
            return base.ExecuteFunction<Nullable<global::System.Int32>>("SI24300_pdCheckbeforedelete", cpnyIDParameter, userNameParameter, langIDParameter, wardParameter);
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="SI24300Model", Name="SI_Ward")]
    [Serializable()]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="SI24300Model", Name="SI24300_pcDistrict_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class SI24300_pcDistrict_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new SI24300_pcDistrict_Result object.
        /// </summary>
        /// <param name="district">Initial value of the District property.</param>
        /// <param name="name">Initial value of the Name property.</param>
        /// <param name="state">Initial value of the State property.</param>
        public static SI24300_pcDistrict_Result CreateSI24300_pcDistrict_Result(global::System.String district, global::System.String name, global::System.String state)
        {
            SI24300_pcDistrict_Result sI24300_pcDistrict_Result = new SI24300_pcDistrict_Result();
            sI24300_pcDistrict_Result.District = district;
            sI24300_pcDistrict_Result.Name = name;
            sI24300_pcDistrict_Result.State = state;
            return sI24300_pcDistrict_Result;
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="SI24300Model", Name="SI24300_pcState_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class SI24300_pcState_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new SI24300_pcState_Result object.
        /// </summary>
        /// <param name="state">Initial value of the State property.</param>
        /// <param name="descr">Initial value of the Descr property.</param>
        /// <param name="country">Initial value of the Country property.</param>
        public static SI24300_pcState_Result CreateSI24300_pcState_Result(global::System.String state, global::System.String descr, global::System.String country)
        {
            SI24300_pcState_Result sI24300_pcState_Result = new SI24300_pcState_Result();
            sI24300_pcState_Result.State = state;
            sI24300_pcState_Result.Descr = descr;
            sI24300_pcState_Result.Country = country;
            return sI24300_pcState_Result;
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="SI24300Model", Name="SI24300_pgSI_Ward_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class SI24300_pgSI_Ward_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new SI24300_pgSI_Ward_Result object.
        /// </summary>
        /// <param name="country">Initial value of the Country property.</param>
        /// <param name="state">Initial value of the State property.</param>
        ...
        /// <param name="tstamp">Initial value of the tstamp property.</param>
        public static SI24300_pgSI_Ward_Result CreateSI24300_pgSI_Ward_Result(global::System.String country, global::System.String state, global::System.String stateName, global::System.String district, global::System.String districtName, global::System.String ward, global::System.String wardName, global::System.Byte[] tstamp)
        {
            SI24300_pgSI_Ward_Result sI24300_pgSI_Ward_Result = new SI24300_pgSI_Ward_Result();
            sI24300_pgSI_Ward_Result.Country = country;
            sI24300_pgSI_Ward_Result.State = state;
            sI24300_pgSI_Ward_Result.StateName = stateName;
            sI24300_pgSI_Ward_Result.District = district;
            sI24300_pgSI_Ward_Result.DistrictName = districtName;
            sI24300_pgSI_Ward_Result.Ward = ward;
            sI24300_pgSI_Ward_Result.WardName = wardName;
            sI24300_pgSI_Ward_Result.tstamp = tstamp;
            return sI24300_pgSI_Ward_Result;
        }
