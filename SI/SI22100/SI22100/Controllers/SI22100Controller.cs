...
namespace SI22100.Controllers
{
    ...
    //    [OutputCache(Duration = 1000000, VaryByParam = "lang")]
        ...
        //            string errorDuplicateCode = string.Empty;
        //            bool flagCheck = true;
        //            int index = 1;
        ...
        //                var DuplicateCode = _db.SI_QuestList.FirstOrDefault(x => x.QuestListID.ToUpper() == questListID.ToUpper());
        //                if(DuplicateCode != null)
        //                {
        //                    errorDuplicateCode += (i + 1) + ", ";
        //                    flagCheck = false;
        //                }
        //                try
        //                {
        //                    if (!string.IsNullOrEmpty(questID)) // trống mã câu hỏi
        //                    {
        //                        id = questID.ToDouble();
        //                    }
        //                }
        ...
        //                if(type != "T - Text")
        //                {
        //                    if (string.IsNullOrEmpty(answerDescr))
        //                    {
        ...
        //            message += errorQuestID == "" ? "" : string.Format(Message.GetString("2018082051", null), errorQuestID.TrimEnd(','), Util.GetLang("SI22100QuestID"));
        ...
        //            message += errorDuplicateCode == "" ? "" : string.Format(Message.GetString("2018122750", null), errorDuplicateCode.TrimEnd(','), Util.GetLang("SI22100QuestionGr"));
        ...
        //        else
        //        {
        //            throw new MessageException(MessageType.Message, "2018121250");
        //        }
        //    }
        //    catch(Exception ex)
        //    {
