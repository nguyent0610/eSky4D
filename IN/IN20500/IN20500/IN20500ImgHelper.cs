...
namespace IN20500
{
    public class IN20500ImgHelper
    {
        #region TinhHV Image
        public static byte[] IN20500GetImage(string fileName, string pPath, bool isConfig)
        {
            string path = "";
            ...
            try
            {
                ...
                {
                    path = pathserver + "Images\\IN20500";
                    di = new DirectoryInfo(path);
        ...
        public static void IN20500UploadImage(string fileName, byte[] fileContext, string Path, bool isConfig)
        {
            string uploadDir = "";
            string pathserver = HttpContext.Current.Server.MapPath("");
            pathserver = pathserver.Substring(0, pathserver.Length - 7);
            try
            {
                ...
                {
                    uploadDir = pathserver + "Images\\IN20500";
        ...
        public static void IN20500UploadMedia(string fileName, byte[] Context, string Path, bool isConfig)
        {
            string uploadDir = "";
            string pathserver = HttpContext.Current.Server.MapPath("");
            pathserver = pathserver.Substring(0, pathserver.Length - 7);
