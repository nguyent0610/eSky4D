...
namespace AP10100.Controllers
{
    ...
    public class AP10100Controller : Controller
    {
        ...
        public ActionResult Save(FormCollection data, string branchID,string handle,string batNbr,string refNbr,string docType,string vendID)
        {
            ...
            if (handle == "R")
            {
                var recordBatNbrUpdate = _db.Batches.Where(p => p.BranchID == branchID && p.Module == "AP" && p.EditScrnNbr == "AP10100" && p.BatNbr == batNbr).FirstOrDefault();
            ...
            foreach (AP_Doc created in lstheaderBot.Created)
            {
                ...
                if (objHeader == null)
                {
                    ...
                    {
                        //var recordBatNbr = _db.Batches.Where(p => p.BranchID == branchID && p.Module == "AP" && p.EditScrnNbr == "AP10100")
                        //                                .OrderByDescending(x => x.BatNbr).FirstOrDefault();
                        //// neu da co 1 dong nao do trong databse roi thi
                        //if (recordBatNbr != null)
                        //{
                        //    batNbrIfNull = Convert.ToInt32(recordBatNbr.BatNbr) + 1;
                        //    objHeader.BatNbr = functionBatNbrIfNull(batNbrIfNull);
                        //}
                        ////neu chua co dong nao trong database
                        //else
                        //{
                        //    objHeader.BatNbr = "000001";
                        //}
                        batNbrIfNull = 1;
                    ...
                    else
                    {
                        ...
                        if (batNbrIfNull == 0)
                        {
                            //var recordRefNbr = _db.AP_Doc.Where(p => p.BranchID == branchID && p.BatNbr == batNbr)
                            //    .OrderByDescending(x => x.RefNbr).FirstOrDefault();
                            ////xet dieu kien neu da co ton tai 1 cai RefNbr roi 
                            //if (recordRefNbr != null)
                            //{
                            //    var RefNbrIfNull = Convert.ToInt32(recordRefNbr.RefNbr) + 1;
                            //    objHeader.RefNbr = functionRefNbrIfNull(RefNbrIfNull);
                            //}
                            ////xet dieu kien neu chua ton tai 1 cai RefNbr nao 
                            //else
                            //{
                            //    objHeader.RefNbr = "000001";
                            //}
                        ...
                        else
                        {
                            ...
                            ////xet truong hop RefNbr
                            //var recordRefNbr = _db.AP_Doc.Where(p => p.BranchID == branchID)
                            //    .OrderByDescending(x => x.RefNbr).FirstOrDefault();
                    ...
                    if (tmpBatNbr != "")
                    {
                        ...
                        if (objHeaderBatNbr == null)
                        {
                            ...
                            objHeaderBatNbr.EditScrnNbr = "AP10100";
                ...
                if (record == null && created.LineRef != "")
                    {
                        ...
                        if (batNbr != "")
                        {
                            ...
                            //{
                            //    batNbrIfNull = Convert.ToInt32(recordBatNbr.BatNbr) + 1;
                            //    record.BatNbr = functionBatNbrIfNull(batNbrIfNull);
                            //}
                            ////neu chua co dong nao trong database
                            //else
                            //{
                            //    record.BatNbr = "000001";
                            //}
                            //batNbrIfNull = 1;
                            //record.BatNbr = functionBatNbrIfNull(branchID);
                        ...
                        if (refNbr != "")
                        {
                            ...
                            if (batNbrIfNull == 0)
                            {
                                ...
                                //{
                                //    var RefNbrIfNull = Convert.ToInt32(recordRefNbr.RefNbr) + 1;
                                //    record.RefNbr = functionRefNbrIfNull(RefNbrIfNull);
                                //}
                                ////xet dieu kien neu chua ton tai 1 cai RefNbr nao 
                                //else{
                                //    record.RefNbr = "000001";
                                //}
            ...
            foreach (AP_Trans updated in lstgrd.Updated)
            {
                ...
                if (record != null)
                {
                    ...
                    var recordBatNbrUpdate = _db.Batches.Where(p => p.BranchID == branchID && p.Module == "AP" && p.EditScrnNbr == "AP10100" && p.BatNbr == record.BatNbr).FirstOrDefault();
