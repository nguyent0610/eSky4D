...
namespace AP10100.Controllers
{
    ...
    public class AP10100Controller : Controller
    {
        ...
        {
            var lst = _db.AP_Doc.Where(p => p.BranchID == branchID && p.BatNbr == batNbr && p.RefNbr == refNbr).FirstOrDefault();
        ...
        {
            var recordLastBatNbr = _db.AP10100_ppAPNumbering(branchID, "BatNbr").FirstOrDefault();
            return recordLastBatNbr;
        }

        private string functionRefNbrIfNull(string branchID)
        {
            var recordLastBatNbr = _db.AP10100_ppAPNumbering(branchID, "RefNbr").FirstOrDefault();
            return recordLastBatNbr;
        }
