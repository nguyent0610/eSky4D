...
namespace AP00000
{
    public class AP00000ImgHelper
    {
        #region TinhHV Image
        public static byte[] AP00000GetImage(string fileName, string pPath, bool isConfig)
        {
            string path = "";
            ...
            try
            {
                ...
                {
                    path = pathserver + "Images\\AP00000";
                    di = new DirectoryInfo(path);
        ...
        public static void AP00000UploadImage(string fileName, byte[] fileContext, string Path, bool isConfig)
        {
            string uploadDir = "";
            string pathserver = HttpContext.Current.Server.MapPath("");
            pathserver = pathserver.Substring(0, pathserver.Length - 7);
            try
            {
                ...
                {
                    uploadDir = pathserver + "Images\\AP00000";
