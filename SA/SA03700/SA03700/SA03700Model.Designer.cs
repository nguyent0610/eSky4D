...
namespace SA03700
{
    ...
    /// </summary>
    public partial class SA03700Entities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new SA03700Entities object using the connection string found in the 'SA03700Entities' section of the application configuration file.
        /// </summary>
        public SA03700Entities() : base("name=SA03700Entities", "SA03700Entities")
        {
        ...
        /// <summary>
        /// Initialize a new SA03700Entities object.
        /// </summary>
        public SA03700Entities(string connectionString) : base(connectionString, "SA03700Entities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new SA03700Entities object.
        /// </summary>
        public SA03700Entities(EntityConnection connection) : base(connection, "SA03700Entities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// No Metadata Documentation available.
        /// </summary>
        public ObjectSet<SYS_PassHistory> SYS_PassHistory
        {
            get
            {
                if ((_SYS_PassHistory == null))
                {
                    _SYS_PassHistory = base.CreateObjectSet<SYS_PassHistory>("SYS_PassHistory");
                }
                return _SYS_PassHistory;
            }
        }
        private ObjectSet<SYS_PassHistory> _SYS_PassHistory;
        ...
        /// <summary>
        /// Deprecated Method for adding a new object to the SYS_PassHistory EntitySet. Consider using the .Add method of the associated ObjectSet&lt;T&gt; property instead.
        /// </summary>
        public void AddToSYS_PassHistory(SYS_PassHistory sYS_PassHistory)
        {
            base.AddObject("SYS_PassHistory", sYS_PassHistory);
        }
        ...
        public ObjectResult<global::System.String> SA03700_ppCheckPass(global::System.String userName, global::System.String password)
        {
            ...
            return base.ExecuteFunction<global::System.String>("SA03700_ppCheckPass", userNameParameter, passwordParameter);
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="SA03700Model", Name="SYS_Configurations")]
    [Serializable()]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="SA03700Model", Name="SYS_PassHistory")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class SYS_PassHistory : EntityObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new SYS_PassHistory object.
        /// </summary>
        ...
        /// <param name="lUpd_User">Initial value of the LUpd_User property.</param>
        /// <param name="tstamp">Initial value of the tstamp property.</param>
        public static SYS_PassHistory CreateSYS_PassHistory(global::System.Int32 id, global::System.String userName, global::System.String password, global::System.DateTime crtd_Datetime, global::System.String crtd_Prog, global::System.String crtd_User, global::System.DateTime lUpd_Datetime, global::System.String lUpd_Prog, global::System.String lUpd_User, global::System.Byte[] tstamp)
        {
            SYS_PassHistory sYS_PassHistory = new SYS_PassHistory();
            sYS_PassHistory.ID = id;
            sYS_PassHistory.UserName = userName;
            sYS_PassHistory.Password = password;
            sYS_PassHistory.Crtd_Datetime = crtd_Datetime;
            sYS_PassHistory.Crtd_Prog = crtd_Prog;
            sYS_PassHistory.Crtd_User = crtd_User;
            sYS_PassHistory.LUpd_Datetime = lUpd_Datetime;
            sYS_PassHistory.LUpd_Prog = lUpd_Prog;
            sYS_PassHistory.LUpd_User = lUpd_User;
            sYS_PassHistory.tstamp = tstamp;
            return sYS_PassHistory;
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="SA03700Model", Name="SYS_UserGroup")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="SA03700Model", Name="User")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
