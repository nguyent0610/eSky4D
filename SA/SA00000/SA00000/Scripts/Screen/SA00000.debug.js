...
var tabSA00000_AfterRender = function (obj) {
...
var loadData = function () {
    ...
    if (record) {
        ...
        if (record.data.Images) {
            App.direct.SA00000GetImages(record.data.Images);
        } else {
    ...
    //}
    //App.frmMain.getForm().loadRecord(App.stoUser.getAt(0));
    //App.direct.SA00000GetImages(App.stoUser.getAt(0).data.Images);
};

function UploadImage() {
    App.frmMain.submit({
        waitMsg: 'Uploading your file...',
        url: 'SA00000/SA00000Upload',
...
var chkPublic_Change = function (checkbox, checked) {
    if (checked) {
        App.tabSA00000.closeTab(App.pnlPO_PriceCpny);
    }
    else {
        App.tabSA00000.addTab(App.pnlPO_PriceCpny);
    }
};
