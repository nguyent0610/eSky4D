...
using System.Data;
namespace PO10201.Controllers
{

    [CustomAuthorize]
    [CheckSessionOut]
    [DirectController]
    public class PO10201Controller : Controller
    {

        PO10201Entities _db = Util.CreateObjectContext<PO10201Entities>(false);
        private const string ScreenNbr = "PO10201";
        private FormCollection _form;
        private List<PO10201_pgDetail_Result> _lstPOTrans = new List<PO10201_pgDetail_Result>();
        private List<PO10201_pgLotTrans_Result> _lstLot = new List<PO10201_pgLotTrans_Result>();
        private List<PO10201_pgLoadTaxTrans_Result> _lstTax = new List<PO10201_pgLoadTaxTrans_Result>();
        private PO10201_pdPO_Setup_Result _objPO_Setup;
        private PO10201_pdHeader_Result _poHead;
        ...
        {
            var obj = _db.PO10201_pdHeader(branchID, batNbr).FirstOrDefault();
        ...
        public ActionResult GetAP_VendorTax(string vendID, string ordFromId)
        {
            ...
            return this.Store(_db.PO10201_pdAP_VenDorTaxes(vendID, ordFromId));

        }
        public ActionResult GetPO10201_pgDetail(string rcptNbr, string batNbr, string branchID)
        {
            var lst = _db.PO10201_pgDetail(branchID, batNbr, rcptNbr).ToList();
            return this.Store(lst);

        }
        public ActionResult GetPO10201_pgLoadTaxTrans(string rcptNbr, string batNbr, string branchID)
        {
            return this.Store(_db.PO10201_pgLoadTaxTrans(branchID, batNbr, rcptNbr).ToList());
        }
        public ActionResult GetPO10201_ppCheckingPONbr(string branchID, string poNbr)
        {
            var obj = _db.PO10201_ppCheckingPONbr(branchID, poNbr).FirstOrDefault();
            return this.Store(obj);

        }
        public ActionResult GetPO10201_pdPODetailReceipt(string branchID, string poNbr)
        {
            var obj = _db.PO10201_pdPODetailReceipt(branchID, poNbr, 0, 0, 0).ToList();
            return this.Store(obj);

        }
        public ActionResult GetPO10201_pdPODetailReturn(string branchID, string poNbr)
        {
            var obj = _db.PO10201_pdPODetailReturn(branchID, poNbr).ToList();
            return this.Store(obj);

        }
        public ActionResult GetLotTrans(string rcptNbr, string batNbr, string branchID, string type, string poNbr)
        {
            var lst = _db.PO10201_pgLotTrans(branchID, batNbr, rcptNbr, type, poNbr).ToList();
            return this.Store(lst);
        }
        ...
        public ActionResult Save(FormCollection data)
        {
            try
            {
                ...
                _poHead = detHeader.ObjectData<PO10201_pdHeader_Result>().FirstOrDefault();

                var detHandler = new StoreDataHandler(data["lstDet"]);
                _lstPOTrans = detHandler.ObjectData<PO10201_pgDetail_Result>()
        ...
        public ActionResult DeleteGrd(FormCollection data)
        {
            try
            {
                ...
                ChangeRecords<PO10201_pgDetail_Result> lst = dataHandler.BatchObjectData<PO10201_pgDetail_Result>();
                ...
                {
                    foreach (PO10201_pgDetail_Result deleted in lst.Deleted.Where(p => p.tstamp != ""))
                    {
        ...
        //get price
        [DirectMethod]
        public ActionResult PO10201POPrice(string branchID = "", string invtID = "", string Unit = "", DateTime? podate = null)
        {
            var result = _db.PO10201_ppGetPrice(branchID, invtID, Unit, podate).FirstOrDefault().Value;
            return this.Direct(result);

        }
        [DirectMethod]
        public ActionResult PO10201ItemSitePrice(string branchID = "", string invtID = "", string siteID = "")
        {
        ...
        private void Updating_PO_Trans(PO10201_pgDetail_Result objr, ref PO_Trans objPO_Tr)
        {
            try
            {
        ...
        private void Update_PO_LotTrans(PO10201_pgLotTrans_Result row, PO_LotTrans objPO_LotTrans)
        {
        ...
        private bool Data_Checking(bool isCheckInvoicePass = false)
        {
            if (_poHead.Status == "H")
            {
                ...
                {
                    PO10201_pgDetail_Result objPO_Trans = new PO10201_pgDetail_Result();
                ...
                if (_db.PO10201_ppCheckCloseDate(_branchID, _poHead.RcptDate.ToDateShort()).FirstOrDefault() == "0")
