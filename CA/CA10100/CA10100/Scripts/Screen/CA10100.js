...
var keys = ['EntryID'];//khóa của record
var fieldsCheckRequire = ["EntryID"];
var fieldsLangCheckRequire = ["EntryID"];
...
var grdDetail_BeforeEdit = function (editor, e) {
    ...
    if (e.field == 'EntryID') {
        App.cboEntryID.store.clearFilter();
        App.cboEntryID.store.filter('RcptDisbFlg', App.cboType.getValue());
    }
