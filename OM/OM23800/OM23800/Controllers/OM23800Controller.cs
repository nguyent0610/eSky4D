            ...
            try
            {
                ...
                try
                {
                    ...
                    foreach (DataRow r in dt.Rows)
                    {
                        ...
                        objmaster.Crtd_Prog = _screenName;
        ...
        public void CreateItemNotCommit(clsOM_SalesRouteMaster objSaleMaster, DataAccess _daapp, bool IsMonth)//(clsOM_SalesRouteMaster objSaleMaster)
        {
            ...
            if (row.SlsFreqType == "R")
            {
                ...
                for (Int32 i = iWeekStart; i <= iWeekEnd; i++)
                {
                    ...
                    #endregion
                    #region row.SlsFreq == "F4" || objSaleMaster.SlsFreq == "F8" || objSaleMaster.SlsFreq == "F8A" || objSaleMaster.SlsFreq == "F12" || objSaleMaster.SlsFreq == "F16" || objSaleMaster.SlsFreq == "F20" || objSaleMaster.SlsFreq == "F24" || objSaleMaster.SlsFreq == "A")
                    else if (row.SlsFreq == "F4" || row.SlsFreq == "F4A" || objSaleMaster.SlsFreq == "F8" || objSaleMaster.SlsFreq == "F8A" || objSaleMaster.SlsFreq == "F12" || objSaleMaster.SlsFreq == "F16" || objSaleMaster.SlsFreq == "F20" || objSaleMaster.SlsFreq == "F24" || objSaleMaster.SlsFreq == "A")
                    {
                        if (row.Mon && dMon <= Todate && dMon >= Fromdate)
                        {
                            var objOM_SalesRouteDet1 = new clsOM_SalesRouteDet(_daapp);
                        ...
                        if (objSaleMaster.SlsFreq == "F8A" || objSaleMaster.SlsFreq == "F4A")
                        {
                            if ((row.WeekofVisit == "OW" && (i % 2) != 0) || (row.WeekofVisit == "EW" && (i % 2) == 0) || (row.WeekofVisit == "NA" && (i % 2) == (iWeekStart % 2)))
                            {
                                if (row.Sat && dSat <= Todate && dSat >= Fromdate)
                                {
                                    var objOM_SalesRouteDet1 = new clsOM_SalesRouteDet(_daapp);
            ...
            if (objSaleMaster.SlsFreqType == "R")
            {
                ...
                for (Int32 i = iWeekStart; i <= iWeekEnd; i++)
                {
                    ...
                    else if (objSaleMaster.SlsFreq == "F4" || objSaleMaster.SlsFreq == "F4A" || objSaleMaster.SlsFreq == "F8" || objSaleMaster.SlsFreq == "F8A" || objSaleMaster.SlsFreq == "F12" || objSaleMaster.SlsFreq == "F16" || objSaleMaster.SlsFreq == "F20" || objSaleMaster.SlsFreq == "F24" || objSaleMaster.SlsFreq == "A")
                    {
                        ...
                        // xet cho ngay thu 7, neu la F8A,F4A thi tuan di tuan nghi
                        if (objSaleMaster.SlsFreq == "F8A" || objSaleMaster.SlsFreq == "F4A")
                        {
                            if ((objSaleMaster.WeekofVisit == "OW" && (i % 2) != 0) || (objSaleMaster.WeekofVisit == "EW" && (i % 2) == 0) || (objSaleMaster.WeekofVisit == "NA" && (i % 2) == (iWeekStart % 2)))
                            {
                                if (objSaleMaster.Sat && dSat <= Todate && dSat >= Fromdate)
                                {
                                    var objOM_SalesRouteDet1 = new clsOM_SalesRouteDet(_daapp);
