    ...
    grdMCL_commandEdit: function (item, command, record, index, eOpts) {
        if (command == "Edit") {
            ...
            App.storeMcpInfo.serverProxy.url =
                Ext.String.format("OM24100/LoadSalesRouteMaster?branchID={0}&custID={1}&slsPerID={2}", record.data.BranchID, record.data.CustId, record.data.SlsperId);
                        ...
                        for (var i = 0; i < fields.length; i++) {
                            ...
                            if (i == fields.length - 1) {
                                ...
                                if (selectedMarker) {
                                    ...
                                    selectedMarker.icon = "Images/OM24100/circle_" + data.result.Color + ".png";
            ...
            for (i = 0; i < markers.length; i++) {
                ...
                if (data.lat && data.lng) {
                    ...
                    var marker = new google.maps.Marker({
                        ...
                        map: map,
                        title: data.title,
                        icon: Ext.String.format('Images/OM24100/circle_{0}.png', data.color ? data.color : "white"),
