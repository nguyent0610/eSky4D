...
var Event = {
    ...
    Form: {
        ...
        , btnChangeRoute_Click: function () {
            if (HQ.isUpdate && HQ.isInsert) {                
                App.winChangeRoute.show();
                App.cboBranchID.setValue('');
                App.cboBranchID1.setValue('');

                App.cboPJPID.setValue('');
                App.cboPJPID1.setValue('');

                App.cboSalesMan.setValue('');
                App.cboSalesMan1.setValue('');

                App.cboRouteID.setValue('');
                App.cboRouteID1.setValue('');
...
//////////////////////////////////////////////////////////////////////////////
var stoChangeRoute_BeforeLoad = function (sto) {
    HQ.common.showBusy(true, HQ.common.getLang('loadingData'), App.frmChangeRoute);
};

var stoChangeRoute_Load = function (sto) {
//    if (_isLoadMaster) {
    HQ.common.showBusy(false, '', App.frmChangeRoute);
//    }
};


var changeRouteMenuClick = function (command) {
    switch (command) {
        case "first":
...
var chkChanegRouteSelect_Change = function (chk, newValue, oldValue, eOpts) {
...
var btnLoadData_Click = function () {
    ...
    if (HQ.form.checkRequirePass(App.frmChangeRoute))
        App.stoData.reload();
};
...
////Function menuClick
var ChangeRoute_Process = function () {
    if (App.frmChangeRoute.isValid()) {
        App.frmChangeRoute.submit({
            waitMsg: HQ.common.getLang("WaitMsg"),
            url: 'OM23800/ChangeRouteProcess',
            params: {
