...
using System.IO;
using System.Text;
namespace OM20400.Controllers
{
    [DirectController]
    [CustomAuthorize]
    [CheckSessionOut]
    public class OM20400Controller : Controller
    {
        private string _screenNbr = "OM20400";
        private string _userName = Current.UserName;
        OM20400Entities _db = Util.CreateObjectContext<OM20400Entities>(false);
        ...
        {
            return this.Store(_db.OM_OrderType.FirstOrDefault(p => p.OrderType == OrderType));
        }

        public ActionResult GetOM_DocNumbering(string OrderType)
        {
            return this.Store(_db.OM20400_pgOM_DocNumbering(OrderType).ToList());
        }
        ...
        public ActionResult Save(FormCollection data)
        {
            try
            {
                ...
                ChangeRecords<OM20400_pgOM_DocNumbering_Result> lstOM_DocNumbering = dataHandler1.BatchObjectData<OM20400_pgOM_DocNumbering_Result>();
                ...
                foreach (OM20400_pgOM_DocNumbering_Result deleted in lstOM_DocNumbering.Deleted)
                {
                ...
                foreach (OM20400_pgOM_DocNumbering_Result curLang in lstOM_DocNumbering.Created)
                {
        ...
        private void UpdatingOM_DocNumbering(OM_DocNumbering t, OM20400_pgOM_DocNumbering_Result s, bool isNew)
        {
            if (isNew)
            {
