var menuClick = function (command) {
    switch (command) {
        case "first":       
            App.SelectionModelAR_SellingProducts.select(0);
            break;
        case "prev":
            App.SelectionModelAR_SellingProducts.selectPrevious();
            break;
        case "next":
            App.SelectionModelAR_SellingProducts.selectNext();
            break;
        case "last":
            App.SelectionModelAR_SellingProducts.select(App.Store1.getCount() - 1);
            break;
        case "refresh":
