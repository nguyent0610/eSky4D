var menuClick = function (command) {
    switch (command) {
        case "first":       
            App.SelectionModelAR_Channel.select(0);
            break;
        case "prev":
            App.SelectionModelAR_Channel.selectPrevious();
            break;
        case "next":
            App.SelectionModelAR_Channel.selectNext();
            break;
        case "last":
            App.SelectionModelAR_Channel.select(App.Store1.getCount() - 1);
            break;
        case "refresh":
