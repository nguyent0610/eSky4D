...
namespace AR20400
{
    public class AR20400ImgHelper
    {
        #region TinhHV Image
        public static byte[] AR20400GetImage(string fileName, string pPath, bool isConfig)
        {
            string path = "";
            ...
            try
            {
                ...
                {
                    path = pathserver + "Images\\AR20400";
                    di = new DirectoryInfo(path);
        ...
        public static void AR20400UploadImage(string fileName, byte[] fileContext, string Path, bool isConfig)
        {
            string uploadDir = "";
            string pathserver = HttpContext.Current.Server.MapPath("");
            pathserver = pathserver.Substring(0, pathserver.Length - 7);
            try
            {
                ...
                {
                    uploadDir = pathserver + "Images\\AR20400";
        ...
        public static void AR20400UploadMedia(string fileName, byte[] Context, string Path, bool isConfig)
        {
            string uploadDir = "";
            string pathserver = HttpContext.Current.Server.MapPath("");
            pathserver = pathserver.Substring(0, pathserver.Length - 7);
        ...
        public static bool AR20400CopyMedia(string fileName, string tmpOldFileName, string Path, bool isConfig)
        {
            var isSuccess = false;
