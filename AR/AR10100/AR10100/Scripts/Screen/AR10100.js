                ...
                if (_focusrecord == 2 )
                {
                    if (App.tabDocument.getForm().getRecord() != null) {
                        ...
                        if (App.storeGrid.getCount() == 0) {
                            ...
                            App.SelectionRowOnGridTab1.selected.items[0].set('TranDesc', custIDAndName)
...
var fillDataIntoGrid2Tab2 = function () {
    ...
    for (var i = 0; i <= App.storeGridTopTab2.getCount() - 1; i++) {
        ...
        if (App.SelectionRowOnGridTopTab2.selected.items[0].data.TaxID == "OVAT05-00") {
            oVat05 = "1";
            taxAmtTotalOVAT05 = taxAmtTotalOVAT05 + parseFloat(App.SelectionRowOnGridTopTab2.selected.items[0].data.TaxAmt)
            tranAmtTotalOVAT05 = tranAmtTotalOVAT05 + parseFloat(App.SelectionRowOnGridTopTab2.selected.items[0].data.TxblAmt)
        } else if (App.SelectionRowOnGridTopTab2.selected.items[0].data.TaxID == "VAT00") {
            Vat00 = "1";
            taxAmtTotalVAT00 = taxAmtTotalVAT00 + parseFloat(App.SelectionRowOnGridTopTab2.selected.items[0].data.TaxAmt)
            tranAmtTotalVAT00 = tranAmtTotalVAT00 + parseFloat(App.SelectionRowOnGridTopTab2.selected.items[0].data.TxblAmt)
        } else if (App.SelectionRowOnGridTopTab2.selected.items[0].data.TaxID == "NONEVAT") {
            noneVat = "1";
            taxAmtTotalNoneVat = taxAmtTotalNoneVat + parseFloat(App.SelectionRowOnGridTopTab2.selected.items[0].data.TaxAmt)
...
//        App.SelectionRowOnGridTab1.selected.items[0].set('TaxId00', item.value[0]);
//        App.SelectionRowOnGridTab1.selected.items[0].set('TaxId01', "oVat05");
//        App.SelectionRowOnGridTab1.selected.items[0].set('TaxId02', "Vat00");
...
//        App.SelectionRowOnGridTab1.selected.items[0].set('TaxId00', item.value[0]);
//        App.SelectionRowOnGridTab1.selected.items[0].set('TaxId01', "Vat00");
//        App.SelectionRowOnGridTab1.selected.items[0].set('TaxId02', "oVat05");
