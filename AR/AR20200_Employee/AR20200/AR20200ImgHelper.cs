...
namespace AR20200
{
    public class AR20200ImgHelper
    {
        #region TinhHV Image
        public static byte[] AR20200GetImage(string fileName, string pPath, bool isConfig)
        {
            string path = "";
            ...
            try
            {
                ...
                {
                    path = pathserver + "Images\\AR20200";
                    di = new DirectoryInfo(path);
        ...
        public static void AR20200UploadImage(string fileName, byte[] fileContext, string Path, bool isConfig)
        {
            string uploadDir = "";
            string pathserver = HttpContext.Current.Server.MapPath("");
            pathserver = pathserver.Substring(0, pathserver.Length - 7);
            try
            {
                ...
                {
                    uploadDir = pathserver + "Images\\AR20200";
