...
namespace AR20500.Controllers
{
    ...
    public class AR20500Controller : Controller
    {
        ...
        AR20500Entities _db = Util.CreateObjectContext<AR20500Entities>(true);
        ...
        //{
        //    return this.Store(_db.AR20500_pgAccessRightsScreen(cpnyID, userID, type, module, Current.UserName, Current.LangID).ToList());
        //}
        //[HttpPost]
        ...
        //        ChangeRecords<AR20500_pgAccessRightsScreen_Result> lstSYS_AccessDetRights = dataHandler.BatchObjectData<AR20500_pgAccessRightsScreen_Result>();
        //        foreach (AR20500_pgAccessRightsScreen_Result deleted in lstSYS_AccessDetRights.Deleted)
        //        {
        ...
        //        foreach (AR20500_pgAccessRightsScreen_Result curLang in lstSYS_AccessDetRights.Created)
        //        {
        ...
        //    }
        //}
        //private void Update_AccessDetRights(SYS_AccessDetRights t, AR20500_pgAccessRightsScreen_Result s, bool isNew)
        //{
        //    if (isNew)
        //    {
