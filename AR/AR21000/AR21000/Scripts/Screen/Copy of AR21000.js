...
var menuClick = function (command) {
    switch (command) {
        case "first":       
            App.SelectionModelAR_ShopType.select(0);
            break;
        case "prev":
            App.SelectionModelAR_ShopType.selectPrevious();
            break;
        case "next":
            App.SelectionModelAR_ShopType.selectNext();
            break;
        case "last":
            App.SelectionModelAR_ShopType.select(App.Store1.getCount() - 1);
            break;
        case "refresh":
